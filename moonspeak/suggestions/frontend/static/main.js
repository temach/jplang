					...
					if (result.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									userMessage: A3($elm$core$Dict$insert, 'SuggestionsReady', 'Error getting keyword suggestions', model.userMessage)
								}),
							$elm$core$Platform$Cmd$none);
					}
				default:
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Keyword suggestion')
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
