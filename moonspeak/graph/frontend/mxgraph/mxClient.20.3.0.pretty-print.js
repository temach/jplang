...
var mxResources = {
  ...
  add: function (a, b, c) {
    ...
    if (b != mxConstants.NONE) {
      ...
      f = function () {
        if (null != e) if (c) mxUtils.get(e, function (l) {
      ...
      if (null != d) if (c) mxUtils.get(d, function (k) {
...
mxUtils = {
  ...
  getChildNodes: function (a, b) {
    ...
    for (a = a.firstChild; null != a; ) a.nodeType == b && c.push(a),
    a = a.nextSibling;
    return c
  },
  ...
  getPrettyXml: function (a, b, c, d, e) {
    ...
    if (null != a) if (b = null != b ? b : '  ', c = null != c ? c : '', d = null != d ? d : '\n', null != a.namespaceURI && a.namespaceURI != e && (e = a.namespaceURI, null == a.getAttribute('xmlns') && a.setAttribute('xmlns', a.namespaceURI)), a.nodeType == mxConstants.NODETYPE_DOCUMENT) f.push(mxUtils.getPrettyXml(a.documentElement, b, c, d, e));
      ...
      var g = a.firstChild;
      if (null !=
      g) for (; null != g; ) f.push(mxUtils.getPrettyXml(g, b, c, d, e)),
      g = g.nextSibling
    } else if (a.nodeType == mxConstants.NODETYPE_COMMENT) a = mxUtils.getTextContent(a),
    0 < a.length && f.push(c + '<!--' + a + '-->' + d);
    ...
    0 < a.length && f.push(c + mxUtils.htmlEntities(a, !1) + d);
     else if (a.nodeType == mxConstants.NODETYPE_CDATA) a = mxUtils.getTextContent(a),
    0 < a.length && f.push(c + '<![CDATA[' + a + ']]' + d);
     else {
      f.push(c + '<' + a.nodeName);
      g = a.attributes;
      if (null !=
      g) for (var k = 0; k < g.length; k++) {
        var l = mxUtils.htmlEntities(g[k].value);
        f.push(' ' + g[k].nodeName + '="' + l + '"')
      }
      g = a.firstChild;
      if (null != g) {
        for (f.push('>' + d); null != g; ) f.push(mxUtils.getPrettyXml(g, b, c + b, d, e)),
        g = g.nextSibling;
  ...
  extractTextWithWhitespace: function (a) {
    function b(e) {
      if (1 != e.length || 'BR' != e[0].nodeName && '\n' != e[0].innerHTML) for (var f = 0; f < e.length; f++) {
        var g = e[f];
  ...
  get: function (a, b, c, d, e, f, g) {
    ...
    g && (a.setRequestHeaders = function (l, m) {
      ...
      for (var n in g) l.setRequestHeader(n, g[n])
    });
  ...
  clone: function (a, b, c) {
    c = null != c ? c : !1;
    var d = null;
    if (null != a && 'function' == typeof a.constructor) if (a.constructor === Element) d = a.cloneNode(null != c ? !c : !1);
     else {
      d = new a.constructor;
  ...
  removeDuplicates: function (a) {
    for (var b = new mxDictionary, c = [
    ], d = 0; d < a.length; d++) b.get(a[d]) || (c.push(a[d]), b.put(a[d], !0));
    return c
  },
  isNaN: function (a) {
  ...
  arcToCurves: function (a, b, c, d, e, f, g, k, l) {
    ...
    t = d * d,
    u = n / r + q / t;
    1 < u ? (c *= Math.sqrt(u), d *= Math.sqrt(u), f = 0) : (u = 1, f === g && (u = - 1), f = u * Math.sqrt((r * t - r * q - t * n) / (r * q + t * n)));
    n = f * c * m / d;
    q = - 1 * f * d * e / c;
    k = p * n - C * q + k / 2;
    l = C * n + p * q + l / 2;
    r = Math.atan2((m - q) / d, (e - n) / c) - Math.atan2(0, 1);
    f = 0 <= r ? r : 2 * Math.PI + r;
    r = Math.atan2(( - m - q) / d, ( - e - n) / c) - Math.atan2((m - q) / d, (e - n) / c);
    e = 0 <= r ? r : 2 * Math.PI + r;
  ...
  reversePortConstraints: function (a) {
    ...
    b |= (a & mxConstants.DIRECTION_MASK_NORTH) <<
    1;
  ...
  getDirectedBounds: function (a, b, c, d, e) {
    ...
    if (e && (f == mxConstants.DIRECTION_SOUTH || f == mxConstants.DIRECTION_NORTH) || d && (f == mxConstants.DIRECTION_EAST || f == mxConstants.DIRECTION_WEST)) c = b.x,
    b.x = b.width,
    b.width = c;
    if (d && (f == mxConstants.DIRECTION_SOUTH || f == mxConstants.DIRECTION_NORTH) || e && (f == mxConstants.DIRECTION_EAST || f == mxConstants.DIRECTION_WEST)) c = b.y,
    b.y = b.height,
    b.height = c;
  ...
  intersection: function (a, b, c, d, e, f, g, k) {
    ...
    e = ((c - a) * (b - f) - (d - b) * (a - e)) / l;
    return 0 <=
    g && 1 >= g && 0 <= e && 1 >= e ? new mxPoint(a + g * (c - a), b + g * (d - b)) : null
  },
  ...
  removeStylename: function (a, b) {
    ...
    if (null != a) {
      a = a.split(';');
      for (var d = 0; d < a.length; d++) a[d] != b && c.push(a[d])
    }
    return c.join(';')
  },
  removeAllStylenames: function (a) {
    ...
    if (null != a) {
      a = a.split(';');
      for (var c = 0; c <
      a.length; c++) 0 <= a[c].indexOf('=') && b.push(a[c])
    }
    return b.join(';')
  },
  ...
  setStyle: function (a, b, c) {
    ...
    if (null == a || 0 == a.length) d && (a = b + '=' + c + ';');
      ...
      var e = a.indexOf(';');
      a = d ? b + '=' + c + (0 > e ? ';' : a.substring(e)) : 0 > e || e == a.length - 1 ? '' : a.substring(e +
      1)
    } else {
      var f = a.indexOf(';' + b + '=');
  ...
  setStyleFlag: function (a, b, c, d) {
    if (null == a || 0 == a.length) a = d || null == d ? b + '=' + c : b + '=0';
      ...
      a = d || null == d ? a + e + b + '=' + c : a + e + b + '=0';
        ...
        var f = a.indexOf(';', e);
        var g = 0 > f ? a.substring(e + b.length + 1) : a.substring(e + b.length + 1, f);
  ...
  getSizeForString: function (a, b, c, d, e) {
    ...
    null != e && ((e & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (f.style.fontWeight = 'bold'), (e & mxConstants.FONT_ITALIC) ==
    mxConstants.FONT_ITALIC && (f.style.fontStyle = 'italic'), b = [
    ], (e & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && b.push('underline'), (e & mxConstants.FONT_STRIKETHROUGH) == mxConstants.FONT_STRIKETHROUGH && b.push('line-through'), 0 < b.length && (f.style.textDecoration = b.join(' ')));
  ...
  popup: function (a, b) {
    if (b) {
      ...
      c.setClosable(!0);
      c.setVisible(!0)
    } else mxClient.IS_NS ? (c = window.open(), c.document.writeln('<pre>' + mxUtils.htmlEntities(a) + '</pre'), c.document.close()) : (c = window.open(), b = c.document.createElement('pre'), b.innerHTML = mxUtils.htmlEntities(a, !1).replace(/\n/g, '<br>').replace(/ /g, '&nbsp;'), c.document.body.appendChild(b))
  },
  alert: function (a) {
    alert(a)
  },
  ...
  makeDraggable: function (a, b, c, d, e, f, g, k, l, m) {
    ...
    null != d && (a.createDragElement = function () {
      ...
      var p = d.cloneNode(!0),
      q = parseInt(p.style.width),
      r = parseInt(p.style.height);
      p.style.width = Math.round(q * n.view.scale) + 'px';
      p.style.height = Math.round(r * n.view.scale) + 'px';
      return p
    }));
    return a
  },
  ...
  removeListener: function () {
    var a = function (b, c, d) {
      if (null != b.mxListenerList) {
        ...
        for (var e = 0; e < c; e++) if (b.mxListenerList[e].f == d) {
      ...
      if (mxClient.IS_SF && !mxClient.IS_TOUCH) {
        ...
        mxEvent.addGestureListeners(b, mxUtils.bind(this, function (g) {
          ...
          if (!mxEvent.isMouseEvent(g) && 2 == d.length) {
            for (var k = 0; k < d.length; k++) if (g.pointerId == d[k].pointerId) {
              d[k] = g;
              break
            }
            ...
            var l = Math.abs(g - e),
            m = Math.abs(k - f);
            if (l > mxEvent.PINCH_THRESHOLD || m > mxEvent.PINCH_THRESHOLD) a(d[0], l > m ? g > e : k > f, !0, d[0].clientX + (d[1].clientX - d[0].clientX) / 2, d[0].clientY + (d[1].clientY - d[0].clientY) / 2),
            e = g,
            f = k
          }
        }), mxUtils.bind(this, function (g) {
...
mxWindow.prototype.toggleMinimized = function (a) {
  this.activate();
  if (this.minimized) this.minimized = !1,
  ...
  this.fireEvent(new mxEventObject(mxEvent.NORMALIZE, 'event', a));
   else {
    this.minimized = !0;
  ...
  g = mxUtils.bind(this, function (k) {
    ...
    if ('none' != this.maximize.style.display) {
      if (a) {
        ...
        if ('auto' == l.overflow || null != this.resize) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection + 'px';
        ...
        if ('auto' == l.overflow || null != this.resize) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection +
        'px';
...
mxDragSource.prototype.graphContainsEvent = function (a, b) {
  ...
  if (this.checkEventSource) for (; null != b && b != a.container; ) b = b.parentNode;
...
mxDragSource.prototype.mouseMove = function (a) {
  ...
  if (null == this.dragElement || null != this.previewElement && 'visible' == this.previewElement.style.visibility) null != this.dragElement && (this.dragElement.style.visibility = 'hidden');
   else {
...
mxDragSource.prototype.dragOver = function (a, b) {
  ...
  if (null != this.previewElement) {
    ...
    var f = !0;
    if (null != this.currentGuide && this.currentGuide.isEnabledForEvent(b)) a = parseInt(this.previewElement.style.width),
    f = parseInt(this.previewElement.style.height),
    a = new mxRectangle(0, 0, a, f),
    c = new mxPoint(e, c),
    c = this.currentGuide.move(a, c, d, !0),
    f = !1,
    e = c.x,
    c = c.y;
     else if (d) {
...
function mxPanningManager(a) {
  ...
  this.stop = function () {
    ...
    a.fireEvent(new mxEventObject(mxEvent.PAN));
      ...
      var c = a.panDx,
      d = a.panDy;
      if (0 != c || 0 != d) a.panGraph(0, 0),
      a.view.setTranslate(this.t0x + c / a.view.scale, this.t0y + d / a.view.scale)
    }
  };
...
mxXmlCanvas2D.prototype.text = function (a, b, c, d, e, f, g, k, l, m, n, p, q) {
  if (this.textEnabled && null != e) {
    ...
    null != m && r.setAttribute('overflow', m);
...
function mxSvgCanvas2D(a, b) {
  ...
  if (a.ownerDocument != document) {
    for (; null != a && 'svg' != a.nodeName; ) a = a.parentNode;
    b = a
  }
...
mxSvgCanvas2D.prototype.getFillPattern = function (a, b, c, d) {
  ...
  if (null == f) {
    ...
    k = 0,
    l = e + '-' + k;
    if (null != g) for (f = g.ownerDocument.getElementById(l); null != f && f.ownerSVGElement != g; ) l = e + '-' + k++,
    f = g.ownerDocument.getElementById(l);
...
mxSvgCanvas2D.prototype.updateFill = function () {
  ...
  var b = !1;
  if (null != a.fillColor) if (null != a.gradientColor && a.gradientColor != mxConstants.NONE) {
    b = !0;
  ...
  } else d = String(a.fillColor).toLowerCase();
  b || null == a.fillStyle || 'auto' == a.fillStyle || 'solid' == a.fillStyle ? this.node.setAttribute('fill', d) : (a = this.getFillPattern(a.fillStyle, this.getCurrentStrokeWidth(), d, a.scale), this.root.ownerDocument == document && this.useAbsoluteIds ? (d = this.getBaseUrl().replace(/([\(\)])/g, '\\$1'), this.node.setAttribute('fill', 'url(' + d + '#' + a + ')')) : this.node.setAttribute('fill', 'url(#' + a + ')'))
};
...
mxSvgCanvas2D.prototype.convertHtml = function (a) {
  if (this.useDomParser) {
    ...
    if (null != document.implementation && null != document.implementation.createDocument) {
      ...
      d.innerHTML = a;
      for (a = d.firstChild; null != a; ) d = a.nextSibling,
      c.appendChild(b.adoptNode(a)),
      a = d;
      return c.innerHTML
    }
...
mxSvgCanvas2D.prototype.createDiv = function (a) {
  ...
  if (mxClient.IS_IE || mxClient.IS_IE11 || !document.createElementNS) return mxUtils.isNode(a) && (a = '<div><div>' + mxUtils.getXml(a) + '</div></div>'),
...
mxSvgCanvas2D.prototype.addForeignObject = function (a, b, c, d, e, f, g, k, l, m, n, p, q, r, t) {
  ...
  u.setAttribute('data-moonspeak-locked', 'test-data');
  ...
  this.root.ownerDocument != document && (a = this.createAlternateContent(u, a, b, c, d, e, f, g, k, l, m, n, p), null != a && (u.setAttribute('requiredFeatures', 'http://www.w3.org/TR/SVG11/feature#Extensibility'), b = this.createElement('switch'), b.appendChild(u), b.appendChild(a), q.appendChild(b)));
  t.appendChild(q)
};
mxSvgCanvas2D.prototype.updateTextNodes = function (a, b, c, d, e, f, g, k, l, m, n) {
  ...
  'flex-end' : 'center') + '; ', this.getTextCss(), p, mxUtils.bind(this, function (q, r, t, u, x) {
    a += this.state.dx;
    b += this.state.dy;
    var y = n.firstChild,
    C = y.firstChild,
    A = C.firstChild,
    B = (this.rotateHtml ? this.state.rotation : 0) + (null != m ? m : 0),
    z = (0 != this.foOffset ? 'translate(' + this.foOffset + ' ' + this.foOffset + ')' : '') + (1 != p ? 'scale(' + p + ')' : '');
    this.setCssText(A.firstChild, x);
    this.setCssText(A, u);
    A.setAttribute('data-drawio-colors', 'color: ' + this.state.fontColor + '; ' + (null == this.state.fontBackgroundColor ? '' : 'background-color: ' +
    this.state.fontBackgroundColor + '; ') + (null == this.state.fontBorderColor ? '' : 'border-color: ' + this.state.fontBorderColor + '; '));
    y.setAttribute('width', Math.ceil(1 / Math.min(1, p) * 100) + '%');
    y.setAttribute('height', Math.ceil(1 / Math.min(1, p) * 100) + '%');
    r = Math.round(b + r);
    0 > r ? y.setAttribute('y', r) : (y.removeAttribute('y'), t += 'padding-top: ' + r + 'px; ');
    this.setCssText(C, t + 'margin-left: ' + Math.round(a + q) + 'px;');
    z += 0 != B ? 'rotate(' + B + ' ' + a + ' ' + b + ')' : '';
    '' != z ? n.setAttribute('transform', z) : n.removeAttribute('transform');
...
mxSvgCanvas2D.createCss = function (a, b, c, d, e, f, g, k, l, m, n, p, q) {
  ...
  x = r.x * a;
  r = r.y * b;
  g ? (t = 'width: ' + Math.round(a) + 'px; ', p += 'max-height: ' + Math.round(b) + 'px; ', r = 0) : 'fill' == f ? (t = 'width: ' + Math.round(a) + 'px; ', u = 'height: ' + Math.round(b) + 'px; ', n += 'width: 100%; height: 100%; ', p += 'width: ' + Math.round(a - 2) + 'px; ' + u) : 'width' == f ? (t = 'width: ' + Math.round(a - 2) + 'px; ', n += 'width: 100%; ', p += t, r = 0, 0 < b && (p += 'max-height: ' + Math.round(b) + 'px; ')) : 'block' == f ? (t = 'width: ' + Math.round(a - 2) + 'px; ', n += 'width: 100%; ', c = '', r = 0, p += t, 'middle' == d && (p += 'max-height: ' + Math.round(b) + 'px; ')) : (c = '', r = 0);
  b = '';
...
mxSvgCanvas2D.prototype.appendPolygonClip = function (a, b, c) {
  ...
  a = a.split(/[ ,]+/);
  for (var d = null, e = null, f = null, g = null, k = [
  ], l = 0; l < a.length; l++) {
...
mxSvgCanvas2D.prototype.plainText = function (a, b, c, d, e, f, g, k, l, m, n, p) {
  ...
  for (m = 0; m < t.length; m++) 0 < t[m].length && 0 < mxUtils.trim(t[m]).length && (q = this.createElement('text'), q.setAttribute('x', this.format(a * k.scale) + this.textOffset), q.setAttribute('y', this.format(n * k.scale) + this.textOffset), mxUtils.write(q, t[m]), r.appendChild(q)),
  n += p;
  this.root.appendChild(r);
...
mxSvgCanvas2D.prototype.addTextBackground = function (a, b, c, d, e, f, g, k, l) {
  ...
  if (null != m.fontBackgroundColor || null != m.fontBorderColor) {
    ...
    if (null == n || 0 == n.width || 0 == n.height) n = document.createElement('div'),
    n.style.lineHeight = mxConstants.ABSOLUTE_LINE_HEIGHT ? m.fontSize * mxConstants.LINE_HEIGHT + 'px' : mxConstants.LINE_HEIGHT,
    n.style.fontSize = m.fontSize + 'px',
...
mxGuide.prototype.move = function (a, b, c, d) {
  if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
    d = function (z, v, D) {
      var F = !1;
      D && Math.abs(z - B) < t ? (b.y = z - a.getCenterY(), t = Math.abs(z - B), F = !0) : D || (Math.abs(z - C) < t ? (b.y = z - a.y, t = Math.abs(z - C), F = !0) : Math.abs(z - A) < t && (b.y = z - a.y - a.height, t = Math.abs(z - A), F = !0));
      F && (p = v, q = z, null == this.guideY && (this.guideY = this.createGuideShape(!1), this.guideY.dialect = mxConstants.DIALECT_SVG, this.guideY.pointerEvents = !1, this.guideY.init(this.graph.getView().getOverlayPane())));
      n = n || F
    };
    var e = function (z, v, D) {
      var F = !1;
      D && Math.abs(z - y) < r ? (b.x = z - a.getCenterX(), r = Math.abs(z - y), F = !0) : D || (Math.abs(z - u) < r ? (b.x = z - a.x, r = Math.abs(z - u), F = !0) : Math.abs(z - x) < r && (b.x = z - a.x - a.width, r = Math.abs(z - x), F = !0));
      F && (l = v, m = z, null == this.guideX && (this.guideX = this.createGuideShape(!0), this.guideX.dialect = mxConstants.DIALECT_SVG, this.guideX.pointerEvents = !1, this.guideX.init(this.graph.getView().getOverlayPane())));
      k = k || F
    },
    ...
    A = g.y + g.height,
    B = g.getCenterY();
    for (f = 0; f < this.states.length; f++) g = this.states[f],
    null == g || this.isStateIgnored(g) || (this.horizontal && (e.call(this, g.getCenterX(), g, !0), e.call(this, g.x, g, !1), e.call(this, g.x + g.width, g, !1), null == g.cell && e.call(this, g.getCenterX(), g, !1)), this.vertical && (d.call(this, g.getCenterY(), g, !0), d.call(this, g.y, g, !1), d.call(this, g.y + g.height, g, !1), null == g.cell && d.call(this, g.getCenterY(), g, !1)));
    ...
    n || null == this.guideY ? null != this.guideY && (e = d = null, null != p && null != a && (d = Math.min(a.x + b.x - this.graph.panDx, p.x), e = Math.max(a.x + a.width + b.x - this.graph.panDx, p.x + p.width)), this.guideY.points = null != d && null != e ? [
      ...
      new mxPoint( - this.graph.panDx, q),
      new mxPoint(c.scrollWidth - 3 - this.graph.panDx, q)
    ], this.guideY.stroke = this.getGuideColor(p, !1), this.guideY.node.style.visibility = 'visible', this.guideY.redraw()) :
...
mxShape.prototype.clear = function () {
  if (null != this.node.ownerSVGElement) for (; null != this.node.lastChild; ) this.node.removeChild(this.node.lastChild);
   else this.node.style.cssText = 'position:absolute;' + (null != this.cursor ? 'cursor:' + this.cursor + ';' : ''),
  this.node.innerText = ''
};
...
mxShape.prototype.destroyCanvas = function (a) {
  if (a instanceof mxSvgCanvas2D) {
    ...
    for (b in a.fillPatterns) c = a.fillPatterns[b],
    null != c && (c.mxRefCount = (c.mxRefCount || 0) + 1);
...
mxShape.prototype.getArcSize = function (a, b) {
  if ('1' == mxUtils.getValue(this.style, mxConstants.STYLE_ABSOLUTE_ARCSIZE, 0)) a = Math.min(a / 2, Math.min(b / 2, mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2));
   else {
  ...
  if (null != b && 0 < b.length) {
    ...
    for (g ? a.moveTo(m.x, m.y) : a.lineTo(m.x, m.y); l < (e ? b.length : b.length - 1); ) {
      ...
      if (c && (0 != n || 0 != m) && (null == f || 0 > mxUtils.indexOf(f, l - 1))) {
        ...
        1, b.length)]; l < b.length - 2 && 0 == Math.round(m.x - g.x) && 0 == Math.round(m.y - g.y); ) m = b[mxUtils.mod(l + 2, b.length)],
        l++;
        n = m.x - g.x;
        m = m.y - g.y;
...
mxStencil.prototype.drawChildren = function (a, b, c, d, e, f, g, k, l, m) {
  if (null != g && 0 < e && 0 < f) for (c = g.firstChild; null != c; ) c.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, c, k, l, m),
  c = c.nextSibling
};
  ...
  if ('save' == g) a.save();
    ...
    if ('path' == g) {
      ...
      if ('1' == c.getAttribute('rounded')) {
        p = !1;
        for (var q = Number(c.getAttribute('arcSize')), r = 0, t = [
        ], u = c.firstChild; null != u; ) {
          if (u.nodeType == mxConstants.NODETYPE_ELEMENT) {
            var x = u.nodeName;
            if ('move' == x || 'line' == x) 'move' != x && 0 != t.length || t.push([]),
            t[t.length - 1].push(new mxPoint(k + Number(u.getAttribute('x')) * m, l + Number(u.getAttribute('y')) * n)),
            r++;
             else {
              p = !0;
              break
        ...
        if (!p && 0 < r) for (m = 0; m < t.length; m++) n = !1,
        l = t[m][0],
        k = t[m][t[m].length - 1],
        l.x == k.x && l.y == k.y && (t[m].pop(), n = !0),
        this.addPoints(a, t[m], !0, q, n);
         else p = !0
      }
      if (p) for (u = c.firstChild; null != u; ) u.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, u, d, e, f),
      u = u.nextSibling
    } else if ('close' == g) a.close();
     else if ('move' == g) a.moveTo(k + Number(c.getAttribute('x')) * m, l + Number(c.getAttribute('y')) * n);
     else if ('line' == g) a.lineTo(k + Number(c.getAttribute('x')) * m, l + Number(c.getAttribute('y')) * n);
     ...
     else if ('arc' == g) a.arcTo(Number(c.getAttribute('rx')) * m, Number(c.getAttribute('ry')) * n, Number(c.getAttribute('x-axis-rotation')), Number(c.getAttribute('large-arc-flag')), Number(c.getAttribute('sweep-flag')), k + Number(c.getAttribute('x')) * m, l + Number(c.getAttribute('y')) * n);
     ...
     else if ('roundrect' == g) b = Number(c.getAttribute('arcsize')),
    0 == b && (b = 100 * mxConstants.RECTANGLE_ROUNDING_FACTOR),
    d = Number(c.getAttribute('w')) * m,
    f = Number(c.getAttribute('h')) * n,
    b = Number(b) / 100,
    b = Math.min(d * b, f * b),
    a.roundrect(k + Number(c.getAttribute('x')) * m, l + Number(c.getAttribute('y')) * n, d, f, b, b);
     ...
     else if ('image' == g) b.outline || (b = this.evaluateAttribute(c, 'src', b), a.image(k + Number(c.getAttribute('x')) * m, l + Number(c.getAttribute('y')) * n, Number(c.getAttribute('w')) * m, Number(c.getAttribute('h')) * n, b, !1, '1' == c.getAttribute('flipH'), '1' == c.getAttribute('flipV')));
     ...
     else if ('include-shape' == g) p = mxStencilRegistry.getStencil(c.getAttribute('name')),
    null != p && (k += Number(c.getAttribute('x')) * m, l += Number(c.getAttribute('y')) * n, d = Number(c.getAttribute('w')) * m, f = Number(c.getAttribute('h')) * n, p.drawShape(a, b, k, l, d, f));
     else if ('fillstroke' == g) a.fillAndStroke();
     else if ('fill' == g) a.fill();
     else if ('stroke' == g) a.stroke();
     else if ('strokewidth' == g) m = '1' == c.getAttribute('fixed') ? 1 : p,
    a.setStrokeWidth(Number(c.getAttribute('width')) * m);
...
(function () {
  function a(d) {
    d = null != d ? d : 2;
    return function (e, f, g, k, l, m, n, p, q, r) {
      f = l * q * 1.118;
      p = m * q * 1.118;
      l *= n + q;
      m *= n + q;
  ...
  function c(d, e, f, g, k, l, m, n, p, q) {
    ...
    return function () {
      ...
      d.lineTo(r.x -
      k / 2 - l / t, r.y + k / t - l / 2);
      d.lineTo(r.x - k, r.y - l);
      d.lineTo(r.x - k / 2 + l / t, r.y - l / 2 - k / t);
      d.close();
      q ? d.fillAndStroke() : d.stroke()
    }
  }
  ...
  mxMarker.addMarker('oval', function (d, e, f, g, k, l, m, n, p, q) {
    var r = m / 2,
    t = g.clone();
    g.x -= k * r;
    g.y -= l * r;
    return function () {
      d.ellipse(t.x - r, t.y - r, m, m);
      q ? d.fillAndStroke() : d.stroke()
    }
  });
  mxMarker.addMarker('baseDash', function (d, e, f, g, k, l, m, n, p, q) {
    var r = k * (m + p + 1),
    t = l * (m + p + 1);
    return function () {
      d.begin();
      d.moveTo(g.x - t / 2, g.y + r / 2);
      d.lineTo(g.x + t / 2, g.y - r / 2);
      d.stroke()
    }
  });
  mxMarker.addMarker('doubleBlock', function (d, e, f, g, k, l, m, n, p, q) {
    e = k * p * 1.118;
    n = l * p * 1.118;
    k *= m + p;
    l *= m + p;
    ...
    return function () {
      d.begin();
      d.moveTo(r.x, r.y);
      d.lineTo(r.x - k - l / 2, r.y - l + k / 2);
      d.lineTo(r.x +
      l / 2 - k, r.y - l - k / 2);
      d.close();
      d.moveTo(r.x - k, r.y - l);
      d.lineTo(r.x - 2 * k - 0.5 * l, r.y + 0.5 * k - 2 * l);
      d.lineTo(r.x - 2 * k + 0.5 * l, r.y - 0.5 * k - 2 * l);
      d.close();
      q ? d.fillAndStroke() : d.stroke()
    }
...
mxRectangleShape.prototype.paintBackground = function (a, b, c, d, e) {
  if (this.isRounded) {
    if ('1' == mxUtils.getValue(this.style, mxConstants.STYLE_ABSOLUTE_ARCSIZE, 0)) var f = Math.min(d / 2, Math.min(e / 2, mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, mxConstants.LINE_ARCSIZE) / 2));
     else f = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, 100 * mxConstants.RECTANGLE_ROUNDING_FACTOR) / 100,
    f = Math.min(d * f, e * f);
...
mxArrowConnector.prototype.paintEdgeShape = function (a, b) {
  ...
  if (0 != u) {
    ...
    r = x;
    t = C;
    if (k && !g) this.paintMarker(a, b[0].x, b[0].y, x, C, n, d, f, m, !0);
     else {
      var v = b[0].x + u / 2 + m * x;
      var D = b[0].y + B / 2 + m * C;
      var F = b[0].x - u / 2 + m * x,
      L = b[0].y - B / 2 + m * C;
      g ? (a.moveTo(v, D), z.push(function () {
        a.lineTo(F, L)
      })) : (a.moveTo(F, L), a.lineTo(v, D))
    }
    var E = D = v = 0;
    for (u = 0; u < b.length - 2; u++) if (B = mxUtils.relativeCcw(b[u].x, b[u].y, b[u + 1].x, b[u + 1].y, b[u + 2].x, b[u + 2].y), v = b[u +
    2].x - b[u + 1].x, D = b[u + 2].y - b[u + 1].y, E = Math.sqrt(v * v + D * D), 0 != E) {
      y = v / E;
      A = D / E;
      E = Math.max(Math.sqrt((x * y + C * A + 1) / 2), 0.04);
      v = x + y;
      D = C + A;
      var G = Math.sqrt(v * v + D * D);
      if (0 != G) {
        v /= G;
        D /= G;
        G = Math.max(E, Math.min(this.strokewidth / 200 + 0.04, 0.35));
        E = 0 != B && p ? Math.max(0.1, G) : Math.max(E, 0.06);
        var H = b[u + 1].x + D * f / 2 / E,
        I = b[u + 1].y - v * f / 2 / E;
        D = b[u + 1].x - D * f / 2 / E;
        v = b[u + 1].y + v * f / 2 / E;
        0 != B && p ? - 1 == B ? (B = D + A * f, E = v - y * f, a.lineTo(D + C * f, v - x * f), a.quadTo(H, I, B, E), function (J, K) {
          z.push(function () {
            a.lineTo(J, K)
          })
        }(D, v)) : (a.lineTo(H, I), function (J, K) {
          var O = H - C * f,
          P = I + x * f,
          Q = H - A * f,
          R = I + y * f;
    ...
    u = f * A;
    B = - f * y;
    if (l && !g) this.paintMarker(a, q.x, q.y, - x, - C, c, e, f, m, !1);
     else {
      a.lineTo(q.x - m * y + u / 2, q.y - m * A + B / 2);
      var M = q.x - m * y - u / 2,
      N = q.y - m * A - B / 2;
      g ? (a.moveTo(M, N), z.splice(0, 0, function () {
        a.moveTo(M, N)
      })) : a.lineTo(M, N)
    }
    for (u = z.length - 1; 0 <= u; u--) z[u]();
    g ? (a.end(), a.stroke()) : (a.close(), a.fillAndStroke());
    a.setShadow(!1);
    a.setMiterLimit(4);
    p && a.setLineJoin('flat');
    2 < b.length && (a.setMiterLimit(4), k && !g && (a.begin(), this.paintMarker(a, b[0].x, b[0].y, r, t, n, d, f, m, !0), a.stroke(), a.end()), l && !g && (a.begin(), this.paintMarker(a, q.x, q.y, - x, - C, c, e, f, m, !0), a.stroke(), a.end()))
  }
};
...
function mxText(a, b, c, d, e, f, g, k, l, m, n, p, q, r, t, u, x, y, C, A, B) {
  mxShape.call(this);
  this.value = a;
  this.bounds = b;
  ...
  this.overflow = null != C ? C : 'visible';
...
mxText.prototype.redraw = function () {
  ...
  mxUtils.isNode(this.value) || this.dialect == mxConstants.DIALECT_STRICTHTML ? this.lastValue = this.value : this.lastValue = null
};
...
mxText.prototype.updateBoundingBox = function () {
  ...
  if (!(this.ignoreStringSize || null == a || 'fill' == this.overflow || this.clipped && this.ignoreClippedStringSize && c == mxConstants.ALIGN_CENTER && d == mxConstants.ALIGN_MIDDLE)) {
    d = c = null;
    if (null != a.ownerSVGElement) if (null != a.firstChild && null != a.firstChild.firstChild && 'foreignObject' == a.firstChild.firstChild.nodeName) a = a.firstChild.firstChild.firstChild.firstChild,
    ...
    c = 'width' == this.overflow ? this.boundingBox.width : a.offsetWidth * this.scale;
      ...
      if (null == this.offsetWidth || null == this.offsetHeight) null != c && (this.updateFont(c), this.updateSize(c, !1), this.updateInnerHtml(c), a = c),
      e = a,
      8 != document.documentMode || mxClient.IS_EM ? null != e.firstChild && 'DIV' == e.firstChild.nodeName && (e = e.firstChild) : (d = Math.round(this.bounds.width / this.scale), this.wrap && 0 < d ? (a.style.wordWrap = mxConstants.WORD_WRAP, a.style.whiteSpace = 'normal', 'break-word' != a.style.wordWrap && (a = e.getElementsByTagName('div'), 0 < a.length && (e = a[a.length -
      1]), c = e.offsetWidth + 2, a = this.node.getElementsByTagName('div'), this.clipped && (c = Math.min(d, c)), 1 < a.length && (a[a.length - 2].style.width = c + 'px'))) : a.style.whiteSpace = 'nowrap'),
...
mxText.prototype.redrawHtmlShapeWithCss3 = function () {
  ...
  null, c, d, this.scale, mxUtils.bind(this, function (e, f, g, k, l, m) {
...
mxText.prototype.fixFlexboxForIe11 = function (a) {
  for (var b = a.querySelectorAll('div[style*="display: flex; justify-content: flex-end;"]'), c = 0; c < b.length; c++) b[c].style.justifyContent = 'flex-start',
  b[c].style.flexDirection = 'row-reverse';
  if (!this.wrap) for (b = a.querySelectorAll('div[style*="display: flex; justify-content: center;"]'), a = - window.innerWidth, c = 0; c < b.length; c++) b[c].style.marginLeft = a + 'px',
  b[c].style.marginRight = a + 'px'
};
...
mxText.prototype.updateHtmlFilter = function () {
  ...
  if (null != f) {
    ...
    if (this.wrap && 0 < k) {
      ...
      f.style.width = l + 'px'
    } else f.style.whiteSpace = 'nowrap';
    g = f;
    ...
    e = g.offsetHeight + 2
  } else null != g.firstChild && 'DIV' == g.firstChild.nodeName && (g = g.firstChild, e = g.offsetHeight);
...
mxText.prototype.updateValue = function () {
  if (mxUtils.isNode(this.value)) this.node.innerText = '',
...
mxSwimlane.prototype.paintSwimlane = function (a, b, c, d, e, f) {
  ...
  a.fill(), f < e && (g != mxConstants.NONE && k || (a.pointerEvents = !1), g != mxConstants.NONE && a.setFillColor(g), a.begin(), a.moveTo(0, f), a.lineTo(0, e), a.lineTo(d, e), a.lineTo(d, f), n ? g == mxConstants.NONE ? a.stroke() : n && a.fillAndStroke() : g != mxConstants.NONE && a.fill())) : (a.begin(), a.moveTo(f, 0), a.lineTo(0, 0), a.lineTo(0, e), a.lineTo(f, e), m ? a.fillAndStroke() : a.fill(), f < d && (g != mxConstants.NONE && k || (a.pointerEvents = !1), g != mxConstants.NONE && a.setFillColor(g), a.begin(), a.moveTo(f, 0), a.lineTo(d, 0), a.lineTo(d, e), a.lineTo(f, e), n ? g == mxConstants.NONE ? a.stroke() : n && a.fillAndStroke() : g != mxConstants.NONE && a.fill()));
...
mxGraphLayout.prototype.setEdgeStyleEnabled = function (a, b) {
  this.graph.setCellStyles(mxConstants.STYLE_NOEDGESTYLE, b ? '0' : '1', [
    a
  ])
};
mxGraphLayout.prototype.setOrthogonalEdge = function (a, b) {
  this.graph.setCellStyles(mxConstants.STYLE_ORTHOGONAL, b ? '1' : '0', [
    a
  ])
};
...
mxGraphLayout.prototype.setEdgePoints = function (a, b) {
  if (null != a) {
    ...
    if (null != this.parent && null != b) {
      ...
      for (var f = 0; f < b.length; f++) b[f].x -= e.x,
      b[f].y -= e.y
    }
    d.points = b;
    c.setGeometry(a, d)
...
mxStackLayout.prototype.getLayoutCells = function (a) {
  for (var b = this.graph.getModel(), c = b.getChildCount(a), d = [
  ], e = 0; e < c; e++) {
...
mxStackLayout.prototype.execute = function (a) {
  if (null != a) {
    ...
    try {
      l = 0;
      k = null;
      for (var m = 0, n = null, p = this.getLayoutCells(a), q = 0; q < p.length; q++) {
        var r = p[q],
        t = d.getGeometry(r);
        if (null != t) {
          t = t.clone();
...
mxCompactTreeLayout.prototype.execute = function (a, b) {
  ...
  if (null == b) if (0 < this.graph.getEdges(a, c.getParent(a), this.invert, !this.invert, !1).length) this.root = a;
    ...
    if (b = this.graph.findTreeRoots(a, !0, this.invert), 0 < b.length) for (var d = 0; d < b.length; d++) if (!this.isVertexIgnored(b[d]) && 0 < this.graph.getEdges(b[d], null, this.invert, !this.invert, !1).length) {
      this.root = b[d];
      break
    }
  } else this.root = b;
  if (null != this.root) {
    ...
    try {
      if (this.visited = {
      }, this.node = this.dfs(this.root, a), this.alignRanks && (this.maxRankHeight = [
      ], this.findRankHeights(this.node, 0), this.setCellHeights(this.node, 0)), null != this.node) {
...
mxCompactTreeLayout.prototype.findRankHeights = function (a, b) {
  ...
  for (a = a.child; null != a; ) this.findRankHeights(a, b + 1),
  a = a.next
};
mxCompactTreeLayout.prototype.setCellHeights = function (a, b) {
  ...
  for (a = a.child; null != a; ) this.setCellHeights(a, b + 1),
  a = a.next
};
...
mxCompactTreeLayout.prototype.verticalLayout = function (a, b, c, d, e) {
  ...
  e = this.apply(a, e);
  b = a.child;
  if (null != b) for (e = this.verticalLayout(b, a, a.x, a.y, e), c = a.x + b.offsetY, d = b.next; null != d; ) e = this.verticalLayout(d, a, c, a.y + b.offsetX, e),
  c += d.offsetY,
  d = d.next;
  return e
};
...
mxCompactTreeLayout.prototype.processNodeOutgoing = function (a) {
  ...
  for (var k = 0; k < e.length; k++) {
    ...
    for (var n = [
    ], p, q, r = 0; r < l.length; r++) this.horizontal ? (p = g.x + g.width, q = g.y + b, n.push(new mxPoint(p, q)), p = g.x + g.width + f, n.push(new mxPoint(p, q)), q = m.y + m.height / 2) : (p = g.x + b, q = g.y + g.height, n.push(new mxPoint(p, q)), q = g.y + g.height + f, n.push(new mxPoint(p, q)), p = m.x + m.width / 2),
    n.push(new mxPoint(p, q)),
    this.setEdgePoints(l[r], n);
...
mxRadialTreeLayout.prototype.execute = function (a, b) {
  ...
  var g = 0,
  k = 0;
  for (c = 0; c < this.row.length; c++) e = (this.rowMaxX[c] - this.centerX - this.nodeDistance) / this.rowRadi[c],
  ...
  for (c = 0; c < this.row.length; c++) {
    ...
    d.theta = (f.x + f.width / 2 - l) / m * Math.PI * 2
  }
...
mxFastOrganicLayout.prototype.execute = function (a) {
  ...
  try {
    ...
    this.isVertexMovable(g) && (l = this.getVertexBounds(g), null != l && (this.cellLocation[d][0] -= l.width / 2, this.cellLocation[d][1] -= l.height / 2, p = this.graph.snap(Math.round(this.cellLocation[d][0])), q = this.graph.snap(Math.round(this.cellLocation[d][1])), this.setVertexLocation(g, p, q), c = null == c ? p : Math.min(c, p), a = null == a ? q : Math.min(a, q)));
    d = - (c || 0) + 1;
    g = - (a || 0) + 1;
    null != e && (d += e.x, g += e.y);
...
mxCircleLayout.prototype.execute = function (a) {
  ...
  b.beginUpdate();
  try {
    for (var c = 0, d = null, e = null, f = [
    ], g = b.getChildCount(a), k = 0; k < g; k++) {
...
mxParallelEdgeLayout.prototype.findParallels = function (a, b) {
  ...
  if (null != b) for (var e = 0; e < b.length; e++) d(b[e]);
    ...
    for (e = 0; e < f; e++) d(b.getChildAt(a, e))
  }
  return c
};
...
mxParallelEdgeLayout.prototype.layout = function (a) {
  ...
  if (e == d) {
    ...
    c = e.y + e.height / 2;
    for (var f = 0; f < a.length; f++) this.route(a[f], b, c),
    b += this.spacing
    ...
    1) / 2, c = c + g / 2 - d * (a.length - 1) / 2, f = 0; f < a.length; f++) this.route(a[f], b, c),
    b -= e,
    c += d
  }
};
mxParallelEdgeLayout.prototype.route = function (a, b, c) {
  this.graph.isCellMovable(a) && this.setEdgePoints(a, [
    new mxPoint(b, c)
  ])
};
...
mxEdgeLabelLayout.prototype.execute = function (a) {
  for (var b = this.graph.view, c = this.graph.getModel(), d = [
  ], e = [
  ], f = c.getChildCount(a), g = 0; g < f; g++) {
    var k = c.getChildAt(a, g),
    l = b.getState(k);
  ...
  for (d = 0; d < b.length; d++) {
    ...
    for (var f = 0; f < e.length; f++) {
      ...
      if (null != k && 0 < k.length) {
        ...
        null != l && c[d] != l && (g.target = l, 0 == l.connectsAsTarget.length && (l.connectsAsTarget = [
        ]), 0 > mxUtils.indexOf(l.connectsAsTarget, g) && l.connectsAsTarget.push(g))
      }
    }
    c[d].temp[0] = 1
  }
...
mxGraphHierarchyModel.prototype.initialRank = function () {
  ...
  for (b = 0; b < d.length; b++) d[b].temp[0] = - 1;
  for (var e = a.slice(); 0 < a.length; ) {
    c = a[0];
    var f = c.connectsAsTarget;
    var g = c.connectsAsSource;
    var k = !0,
  ...
  for (b = 0; b < e.length; b++) for (c = e[b], a = 0, f = c.connectsAsSource, d = 0; d < f.length; d++) m = f[d],
  m = m.target,
...
mxGraphHierarchyModel.prototype.fixRanks = function () {
  ...
  this.visit(function (f, g, k, l, m) {
    ...
    if (null != f && null != k && 1 < f.maxRank - g.maxRank) for (k.maxRank = f.maxRank, k.minRank = g.maxRank, k.temp = [
    ], k.x = [
    ], k.y = [
    ], f = k.minRank + 1; f < k.maxRank; f++) a[f].push(k),
    k.setGeneralPurposeVariable(f, a[f].length - 1)
  }, c, !1, null)
};
mxGraphHierarchyModel.prototype.visit = function (a, b, c, d) {
  if (null != b) {
    for (var e = 0; e < b.length; e++) {
      ...
      ], f.hashCode[0] = this.dfsCount, f.hashCode[1] = e, this.extendedDfs(null, f, null, a, d, f.hashCode, e, 0)) : this.dfs(null, f, null, a, d, 0))
    }
    this.dfsCount++
  }
};
mxGraphHierarchyModel.prototype.dfs = function (a, b, c, d, e, f) {
  if (null != b) {
    var g = b.id;
    if (null == e[g]) for (e[g] = b, d(a, b, c, f, 0), a = b.connectsAsSource.slice(), c = 0; c < a.length; c++) g = a[c],
    this.dfs(b, g.target, g, d, e, f + 1);
     else d(a, b, c, f, 1)
  }
};
mxGraphHierarchyModel.prototype.extendedDfs = function (a, b, c, d, e, f, g, k) {
  if (null != b) if (null == a || null != b.hashCode && b.hashCode[0] == a.hashCode[0] || (f = a.hashCode.length + 1, b.hashCode = a.hashCode.slice(), b.hashCode[f - 1] = g), g = b.id, null == e[g]) for (e[g] = b, d(a, b, c, k, 0), a = b.connectsAsSource.slice(), c = 0; c < a.length; c++) g = a[c],
...
mxMedianHybridCrossingReduction.prototype.execute = function (a) {
  ...
  for (b = 0; b < this.maxIterations && c < this.maxNoImprovementIterations; b++) {
    ...
    } else for (c++, e = 0; e < this.nestedBestRanks.length; e++) for (f = a.ranks[e], g = 0; g < f.length; g++) k = f[g],
...
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function (a, b) {
  ...
  for (b = 0; b < f.length; b++) a = a.concat(f[b]);
  ...
  for (b = 0; b < f; ++b) e[b] = 0;
  for (b = 0; b < a.length; b++) for (f = a[b] + d, ++e[f]; 0 <
  f; ) f % 2 && (c += e[f + 1]),
  f = f - 1 >> 1,
  ++e[f];
  return c
    ...
    for (var f = 0; f < b.ranks.length; f++) {
      ...
      for (l = 0; l < g.length - 1; l++) {
        if (0 == l) {
          ...
          for (var A = 0; A < m.length; A++) y[A] = m[A].getGeneralPurposeVariable(f +
          1);
          for (A = 0; A < n.length; A++) C[A] = n[A].getGeneralPurposeVariable(f - 1)
        } else m = p,
        n = q,
        y = r,
        C = t,
        ...
        q = u.getPreviousLayerConnectedCells(f);
        r = [
        ];
        t = [
        ];
        for (A = 0; A < p.length; A++) r[A] = p[A].getGeneralPurposeVariable(f + 1);
        for (A = 0; A < q.length; A++) t[A] = q[A].getGeneralPurposeVariable(f - 1);
        var B = 0,
        z = 0;
        for (A = 0; A < y.length; A++) for (var v = 0; v < r.length; v++) y[A] > r[v] && B++,
        y[A] < r[v] && z++;
        for (A = 0; A < C.length; A++) for (v = 0; v < t.length; v++) C[A] > t[v] && B++,
        C[A] < t[v] && z++;
        if (z < B || z == B && e) p = x.getGeneralPurposeVariable(f),
        x.setGeneralPurposeVariable(f, u.getGeneralPurposeVariable(f)),
        u.setGeneralPurposeVariable(f, p),
        p = m,
        q = n,
        r = y,
        t = C,
...
mxMedianHybridCrossingReduction.prototype.weightedMedian = function (a, b) {
  if (a = 0 == a % 2) for (var c = b.maxRank - 1; 0 <= c; c--) this.medianRank(c, a);
   else for (c = 1; c < b.maxRank; c++) this.medianRank(c, a)
};
mxMedianHybridCrossingReduction.prototype.medianRank = function (a, b) {
  for (var c = this.nestedBestRanks[a].length, d = [
  ], e = [
  ], f = 0; f < c; f++) {
...
mxMinimumCycleRemover.prototype.execute = function (a) {
  ...
  if (null != a.roots) {
    ...
    for (e = 0; e < f.length; e++) c[e] = a.vertexMapper.get(f[e])
  }
...
mxCoordinateAssignment.prototype.minNode = function (a) {
  ...
  for (f = 0; 0 < b.length && f <= a; ) {
    ...
    0 < u && (y = (r * p + t * q) / u);
    p = !1;
    y < x - 1 ? 0 == m ? (e.setGeneralPurposeVariable(l, y), p = !0) : (m = d[l][m - 1], x = m.getGeneralPurposeVariable(l), x = x + m.width / 2 + this.intraCellSpacing + e.width / 2, x < y ? (e.setGeneralPurposeVariable(l, y), p = !0) : x < e.getGeneralPurposeVariable(l) - 1 && (e.setGeneralPurposeVariable(l, x), p = !0)) : y > x + 1 && (m == d[l].length - 1 ? (e.setGeneralPurposeVariable(l, y), p = !0) : (m = d[l][m + 1], x = m.getGeneralPurposeVariable(l), x = x - m.width / 2 - this.intraCellSpacing - e.width / 2, x > y ? (e.setGeneralPurposeVariable(l, y), p = !0) : x > e.getGeneralPurposeVariable(l) + 1 && (e.setGeneralPurposeVariable(l, x), p = !0)));
    if (p) {
      for (e = 0; e < k.length; e++) l = k[e],
      l = c.get(l),
      null != l && 0 == l.visited && (l.visited = !0, b.push(l));
...
mxCoordinateAssignment.prototype.medianPos = function (a, b) {
  if (0 == a % 2) for (a = b.maxRank; 0 < a; a--) this.rankMedianPosition(a - 1, b, a);
   else for (a = 0; a < b.maxRank - 1; a++) this.rankMedianPosition(a + 1, b, a)
};
...
mxCoordinateAssignment.prototype.medianXValue = function (a, b) {
  ...
  for (var c = [
  ], d = 0; d < a.length; d++) c[d] = a[d].getGeneralPurposeVariable(b);
  c.sort(function (e, f) {
    return e - f
  });
...
mxCoordinateAssignment.prototype.rankCoordinates = function (a, b, c) {
  ...
  for (var d = !1, e = 0; e < b.length; e++) {
    ...
    } else f.isEdge() && (g = 1, null != f.edges ? g = f.edges.length : mxLog.warn('edge.edges is null'), f.width = (g - 1) * this.parallelEdgeSpacing);
    c += f.width / 2;
    f.setX(a, c);
...
mxCoordinateAssignment.prototype.calculateWidestRank = function (a, b) {
  ...
  for (var d = b.maxRank; 0 <= d; d--) {
    ...
    g;
    for (l = 0; l < f.length; l++) f[l].setY(d, a)
  }
};
    ...
    if (!(1 > d.maxRank - d.minRank - 1)) {
      ...
      if (!f) {
        ...
        for (k = d.minRank + 1; k < d.maxRank - 1; k++) {
          var p = d.getX(k + 1);
          n == p ? (l[k - d.minRank - 1] = n, e++) : this.repositionValid(b, d, k + 1, n) ? (l[k - d.minRank -
          1] = n, e++) : n = l[k - d.minRank - 1] = p
        }
        n = d.getX(k);
        for (k = d.maxRank - 1; k > d.minRank + 1; k--) p = d.getX(k - 1),
        n == p ? (m[k - d.minRank - 2] = n, f++) : this.repositionValid(b, d, k - 1, n) ? (m[k - d.minRank - 2] = n, f++) : (m[k - d.minRank - 2] = d.getX(k - 1), n = p);
        if (f > g || e > g) if (f >= e) for (k = d.maxRank - 2; k > d.minRank; k--) d.setX(k, m[k - d.minRank - 1]);
         else if (e > f) for (k = d.minRank + 2; k < d.maxRank; k++) d.setX(k, l[k - d.minRank - 2])
      }
    }
  }
};
...
mxCoordinateAssignment.prototype.setCellLocations = function (a, b) {
  ...
  for (a = 0; a < b.ranks.length; a++) this.rankTopY[a] = Number.MAX_VALUE,
  this.rankBottomY[a] = - Number.MAX_VALUE;
  var c = b.vertexMapper.getValues();
  for (a = 0; a < c.length; a++) this.setVertexLocation(c[a]);
    ...
    if (e.isVertex()) for (var f = e.getPreviousLayerConnectedCells(b), g = b - 1, k = 0; 2 > k; k++) {
      if ( - 1 < g && g < a.ranks.length && null != f && 0 < f.length) {
        ...
        for (m = 0; m < l.length; m++) {
          var r = l[m].cell;
          if (r.isVertex()) {
            var t = 0 == k ? e.connectsAsSource : e.connectsAsTarget;
            for (var u = 0; u < t.length; u++) if (t[u].source == r || t[u].target == r) f += t[u].edges.length,
            q++,
            g.push(t[u])
        ...
        for (m = 0; m < g.length; m++) for (q = g[m].edges.length, r = this.jettyPositions[g[m].ids[0]], null == r && (r = [
        ], this.jettyPositions[g[m].ids[0]] = r), m < f / 2 ? p += this.prefVertEdgeOff : m > f / 2 && (p -= this.prefVertEdgeOff), t = 0; t < q; t++) r[4 * t + 2 * k] = n,
        n += l,
        r[4 * t + 2 * k + 1] = p
      }
  ...
  if (101207 != a.temp[0]) {
    ...
    for (var e = 0, f = this.jettyPositions[a.ids[0]], g = a.isReversed ? a.target.cell : a.source.cell, k = this.layout.graph, l = this.orientation == mxConstants.DIRECTION_EAST || this.orientation == mxConstants.DIRECTION_SOUTH, m = 0; m < a.edges.length; m++) {
      ...
      if (null != f) {
        ...
        u += x;
        t = f[4 * e + t];
        var y = k.model.getTerminal(n, !0);
        this.layout.isPort(y) && k.model.getParent(y) == p && (t = k.view.getState(y), t = null != t ? t.x : p.geometry.x + a.source.width * y.geometry.x);
        this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH ? (q.push(new mxPoint(t, u)), this.layout.edgeStyle == mxHierarchicalEdgeStyle.CURVE && q.push(new mxPoint(t, u + x))) : (q.push(new mxPoint(u, t)), this.layout.edgeStyle == mxHierarchicalEdgeStyle.CURVE && q.push(new mxPoint(u + x, t)))
      }
      t = a.x.length - 1;
      u = x = - 1;
      p = a.maxRank - 1;
      ...
      for (; a.maxRank != a.minRank && t != x; t += u) {
        y = a.x[t] + b;
        var C = (this.rankTopY[p] + this.rankBottomY[p + 1]) / 2,
...
mxSwimlaneOrdering.prototype.execute = function (a) {
  ...
  if (null != a.roots) {
    ...
    for (var e = 0; e < d.length; e++) c[e] = a.vertexMapper.get(d[e])
  }
  a.visit(function (f, g, k, l, m) {
    ...
    l ? (k.invert(), mxUtils.remove(k, f.connectsAsSource), g.connectsAsSource.push(k), f.connectsAsTarget.push(k), mxUtils.remove(k, g.connectsAsTarget)) :
    m && (k.invert(), mxUtils.remove(k, f.connectsAsTarget), g.connectsAsTarget.push(k), f.connectsAsSource.push(k), mxUtils.remove(k, g.connectsAsSource));
...
mxHierarchicalLayout.prototype.execute = function (a, b) {
  ...
  if (null != b || null != a) {
    ...
    if (null != b) {
      for (var e = [
      ], f = 0; f < b.length; f++) (null != a ? c.isAncestor(a, b[f]) : 1) && c.isVertex(b[f]) && e.push(b[f]);
      this.roots = e
    }
    c.beginUpdate();
    try {
      ...
      null != this.parentX && null != this.parentY && (d = this.graph.getCellGeometry(a), null != d && (d = d.clone(), d.x = this.parentX, d.y = this.parentY, c.setGeometry(a, d)))
    } finally {
      c.endUpdate()
    }
  }
  ...
  if (null != a && null != b) {
    ...
    for (f in b) {
      ...
      if (a.isVertex(g) && this.graph.isCellVisible(g)) {
        for (var k = this.getEdges(g), l = 0, m = 0, n = 0; n < k.length; n++) this.getVisibleTerminal(k[n], !0) == g ? l++ : m++;
        0 == m && 0 < l && c.push(g);
        k = l - m;
        k > e && (e = k, d = g)
      }
...
mxSwimlaneLayout.prototype.execute = function (a, b) {
  ...
  if (!(null == b || 1 > b.length)) {
    ...
    for (var e = [
      ...
      if (null == g || 0 == g.length) g = this.graph.insertVertex(b[f], null, null, 0, 0, this.dummyVertexWidth, 0),
      e.push(g)
    }
    c.beginUpdate();
    try {
...
mxSwimlaneLayout.prototype.updateGroupBounds = function () {
  ...
  b = this.model;
  for (f in b.edgeMapper) for (var c = b.edgeMapper[f], d = 0; d < c.edges.length; d++) a.push(c.edges[d]);
  a = this.graph.getBoundingBoxFromGeometry(a, !0);
  b = [
  ];
  for (d = 0; d < this.swimlanes.length; d++) {
    var e = this.swimlanes[d];
    var f = this.graph.getCellGeometry(e);
    if (null != f) {
  ...
  for (d = 0; d < this.swimlanes.length; d++) if (e = this.swimlanes[d], f = this.graph.getCellGeometry(e), null != f) {
  ...
  if (null != a && null != d) {
    ...
    if (null == d[l] && (null == g || null != g[l])) {
      ...
      for (c = 0; c < m.length; c++) {
        ...
        q >= this.swimlanes.length || !(q > k || (!b || p) && q == k) || (e = this.traverse(n, b, m[c], d, e, f, g, q))
      }
...
mxGraphModel.prototype.filterCells = function (a, b) {
  ...
  if (null != a) {
    ...
    for (var d = 0; d < a.length; d++) b(a[d]) && c.push(a[d])
  }
  return c
};
...
mxGraphModel.prototype.cellAdded = function (a) {
  if (null != a) {
    ...
    for (var c = 0; c < b; c++) this.cellAdded(this.getChildAt(a, c))
  }
};
...
mxGraphModel.prototype.updateEdgeParent = function (a, b) {
  ...
  if (this.isAncestor(b, c) && this.isAncestor(b, d) && (b = c == d ? this.getParent(c) : this.getNearestCommonAncestor(c, d), null != b && (this.getParent(b) != this.root || this.isAncestor(b, a)) && this.getParent(a) !=
  b)) {
...
mxGraphModel.prototype.getNearestCommonAncestor = function (a, b) {
  if (null != a && null != b) {
    ...
    if (null != c && 0 < c.length) {
      ...
      c.length < d.length && (a = b, b = d, d = c, c = b);
      for (; null != a; ) {
        b = this.getParent(a);
        if (0 == c.indexOf(d + mxCellPath.PATH_SEPARATOR) && null != b) return a;
...
mxGraphModel.prototype.getChildCells = function (a, b, c) {
  b = null != b ? b : !1;
  c = null != c ? c : !1;
  for (var d = this.getChildCount(a), e = [
  ], f = 0; f < d; f++) {
...
mxGraphModel.prototype.getEdges = function (a, b, c, d) {
  ...
  c = null != c ? c : !0;
  d = null != d ? d : !0;
  for (var e = this.getEdgeCount(a), f = [
  ], g = 0; g < e; g++) {
...
mxGraphModel.prototype.cloneCells = function (a, b, c, d) {
  ...
  d = null != d ? d : !1;
  for (var e = [
  ], f = 0; f < a.length; f++) null != a[f] ? e.push(this.cloneCellImpl(a[f], c, b, d)) : e.push(null);
...
mxGraphModel.prototype.cloneCellImpl = function (a, b, c, d) {
  ...
  f = b[e];
  if (null == f && (f = this.cellCloned(a), b[e] = f, d && (f.id = a.id), c)) for (c = this.getChildCount(a), e = 0; e < c; e++) {
...
mxGraphModel.prototype.restoreClone = function (a, b, c) {
  ...
  for (var e = 0; e < d; e++) this.restoreClone(this.getChildAt(a, e), this.getChildAt(b, e), c)
};
...
mxCell.prototype.insert = function (a, b) {
  null != a && (null == b && (b = this.getChildCount(), a.getParent() == this && b--), a.removeFromParent(), a.setParent(this), null == this.children ? (this.children = [
  ], this.children.push(a)) : this.children.splice(b, 0, a));
  return a
};
...
mxCell.prototype.insertEdge = function (a, b) {
  null != a && (a.removeFromTerminal(b), a.setTerminal(this, b), null == this.edges || a.getTerminal(!b) != this || 0 > mxUtils.indexOf(this.edges, a)) && (null == this.edges && (this.edges = [
  ]), this.edges.push(a));
  return a
};
...
mxGeometry.prototype.rotate = function (a, b) {
  ...
  if (null != this.points) for (var e = 0; e < this.points.length; e++) null != this.points[e] && (d = mxUtils.getRotatedPoint(this.points[e], a, c, b), this.points[e].x = Math.round(d.x), this.points[e].y = Math.round(d.y))
};
...
mxGeometry.prototype.scale = function (a, b, c) {
  ...
  null != this.sourcePoint && (this.sourcePoint.x = parseFloat(this.sourcePoint.x) * a, this.sourcePoint.y = parseFloat(this.sourcePoint.y) * b);
  null != this.targetPoint && (this.targetPoint.x = parseFloat(this.targetPoint.x) * a, this.targetPoint.y = parseFloat(this.targetPoint.y) * b);
  if (null != this.points) for (var d = 0; d < this.points.length; d++) null != this.points[d] && (this.points[d].x = parseFloat(this.points[d].x) * a, this.points[d].y = parseFloat(this.points[d].y) * b);
...
var mxCellPath = {
  ...
  resolve: function (a, b) {
    if (null != b) {
      ...
      for (var c = 0; c < b.length; c++) a = a.getChildAt(parseInt(b[c]))
    }
    return a
  },
  ...
  HexagonPerimeter: function (a, b, c, d) {
    ...
    if (d) {
      ...
      if (t) {
        ...
        k)) : p > m && p < r ? (b = new mxPoint(e, f - Math.floor(0.25 * k)), u = new mxPoint(e + Math.floor(1.5 * g), f + Math.floor(0.5 * k))) : p > r && p < q - m ? (b = new mxPoint(e - Math.floor(0.5 * g), f + Math.floor(0.5 * k)), u = new mxPoint(e + g, f - Math.floor(0.25 * k))) : p > q - m && p <= q || p < - q + m && p >= - q ? (b = new mxPoint(e, f), u = new mxPoint(e, f + k)) : p < - m && p > - r ? (b = new mxPoint(e + Math.floor(1.5 * g), f + Math.floor(0.5 * k)), u = new mxPoint(e, f + Math.floor(1.25 * k))) : p < - r && p > - q + m && (b = new mxPoint(e - Math.floor(0.5 * g), f + Math.floor(0.5 * k)), u = new mxPoint(e + g, f + Math.floor(1.25 * k)))
      } else {
...
mxPrintPreview.prototype.open = function (a, b, c, d) {
  ...
  f = null;
  try {
    this.printOverlays && (this.graph.cellRenderer.initializeOverlay = function (E, G) {
      G.init(E.view.getDrawPane())
    });
    this.printControls && (this.graph.cellRenderer.initControl = function (E, G, H, I) {
      G.dialect = E.view.graph.dialect;
      G.init(E.view.getDrawPane())
    });
    ...
    var y = mxUtils.bind(this, function () {
      if (this.pageSelector && (1 < x || 1 < u)) {
        var E = this.createPageSelector(x, u);
        k.body.appendChild(E);
        if (mxClient.IS_IE && null == k.documentMode || 5 == k.documentMode || 8 == k.documentMode || 7 == k.documentMode) {
          E.style.position = 'absolute';
          var G = function () {
            E.style.top = (k.body.scrollTop || k.documentElement.scrollTop) + 10 + 'px'
          };
          mxEvent.addListener(this.wnd, 'scroll', function (H) {
            G()
          });
          mxEvent.addListener(this.wnd, 'resize', function (H) {
            G()
          })
        }
      }
    }),
    C = mxUtils.bind(this, function (E, G) {
      null != this.borderColor && (E.style.borderColor = this.borderColor, E.style.borderStyle = 'solid', E.style.borderWidth = '1px');
      E.style.background = this.backgroundColor;
      if (c || G) E.style.pageBreakAfter = 'always';
      if (g && (mxClient.IS_IE || 11 <= document.documentMode || mxClient.IS_EDGE)) k.writeln(E.outerHTML),
      E.parentNode.removeChild(E);
       else if (mxClient.IS_IE || 11 <= document.documentMode || mxClient.IS_EDGE) {
        var H = k.createElement('div');
        H.innerHTML = E.outerHTML;
        H = H.getElementsByTagName('div') [0];
        k.body.appendChild(H);
        E.parentNode.removeChild(E)
      } else E.parentNode.removeChild(E),
      k.body.appendChild(E);
      (c || G) && this.addPageBreak(k)
    }),
    A = this.getCoverPages(this.pageFormat.width, this.pageFormat.height);
    if (null != A) for (var B = 0; B < A.length; B++) C(A[B], !0);
    var z = this.getAppendices(this.pageFormat.width, this.pageFormat.height);
    for (B = 0; B < x; B++) {
      var v = B * t / this.scale - this.y0 / this.scale + (m.y - q.y * n) / n;
      for (a = 0; a < u; a++) {
        if (null == this.wnd) return null;
        var D = a * r / this.scale - this.x0 / this.scale + (m.x - q.x * n) / n,
        F = B * u + a + 1,
        L = new mxRectangle(D, v, r, t);
        f = this.renderPage(this.pageFormat.width, this.pageFormat.height, 0, 0, mxUtils.bind(this, function (E) {
          this.addGraphFragment( - D, - v, this.scale, F, E, L);
          this.printBackgroundImage && this.insertBackgroundImage(E, - D, - v)
        }), F);
        f.setAttribute('id', 'mxPage-' + F);
        C(f, null != z || B < x - 1 || a < u - 1)
      }
    }
    if (null != z) for (B = 0; B < z.length; B++) C(z[B], B <
    z.length - 1);
...
mxPrintPreview.prototype.renderPage = function (a, b, c, d, e, f) {
  ...
  try {
    ...
    l.style.height = b - 2 * this.border + 'px',
    l.style.overflow = 'hidden',
    !mxClient.IS_IE || null != f.documentMode && 5 != f.documentMode && 8 != f.documentMode && 7 != f.documentMode ? (l.style.top = this.border + 'px', l.style.left = this.border + 'px') : (l.style.marginTop = this.border + 'px', l.style.marginLeft = this.border + 'px'),
    g.appendChild(l),
    document.body.appendChild(g),
    k = l
  } catch (n) {
...
mxPrintPreview.prototype.addGraphFragment = function (a, b, c, d, e, f) {
  ...
  if (this.clipping) {
    ...
    C = this;
    this.graph.cellRenderer.redraw = function (B, z, v) {
      if (null != B) {
        var D = x.get(B.cell);
        if (null != D && (D = g.getBoundingBox(D, !1), null != D && 0 < D.width && 0 < D.height && !mxUtils.intersects(y, D)) || !C.isCellVisible(B.cell)) return
      }
  ...
  try {
    ...
    a = new mxTemporaryCellStates(g, c, A, null, mxUtils.bind(this, function (B) {
      return this.getLinkForCellState(B)
    }))
  } finally {
    if (mxClient.IS_IE) g.overlayPane.innerText = '',
    g.canvas.style.overflow = 'hidden',
    g.canvas.style.position = 'relative',
    g.canvas.style.top = this.marginTop + 'px',
    g.canvas.style.width = f.width + 'px',
    g.canvas.style.height = f.height + 'px';
     else for (c = e.firstChild; null != c; ) A = c.nextSibling,
    b = c.nodeName.toLowerCase(),
    'svg' == b ? (c.style.overflow = 'hidden', c.style.position = 'relative', c.style.top = this.marginTop + 'px', c.setAttribute('width', f.width), c.setAttribute('height', f.height), c.style.width = '', c.style.height = '') : 'default' != c.style.cursor && 'div' != b && c.parentNode.removeChild(c),
    c = A;
...
mxCellState.prototype.setAbsoluteTerminalPoint = function (a, b) {
  b ? (null == this.absolutePoints && (this.absolutePoints = [
  ]), 0 == this.absolutePoints.length ? this.absolutePoints.push(a) : this.absolutePoints[0] = a) : null == this.absolutePoints ? (this.absolutePoints = [
...
mxGraphSelectionModel.prototype.setCells = function (a) {
  if (null != a) {
    this.singleSelection && (a = [
      this.getFirstSelectableCell(a)
    ]);
    for (var b = [
    ], c = 0; c < a.length; c++) this.graph.isCellSelectable(a[c]) && b.push(a[c]);
...
mxGraphSelectionModel.prototype.addCells = function (a) {
  if (null != a) {
    var b = null;
    this.singleSelection && (b = this.cells, a = [
      this.getFirstSelectableCell(a)
    ]);
    for (var c = [
    ], d = 0; d < a.length; d++) !this.isSelected(a[d]) && this.graph.isCellSelectable(a[d]) && c.push(a[d]);
...
mxGraphSelectionModel.prototype.removeCells = function (a) {
  if (null != a) {
    for (var b = [
    ], c = 0; c < a.length; c++) this.isSelected(a[c]) && b.push(a[c]);
    this.changeSelection(null, b)
  }
};
mxGraphSelectionModel.prototype.changeSelection = function (a, b) {
  if (null != a && 0 < a.length && null != a[0] || null != b && 0 < b.length && null != b[0]) a = new mxSelectionChange(this, a, b),
  a.execute(),
  b = new mxUndoableEdit(this, !1),
  b.add(a),
...
mxCellEditor.prototype.resize = function () {
  ...
  if (null == a) this.stopEditing(!0);
    ...
    if (this.autoSize && 'fill' != a.style[mxConstants.STYLE_OVERFLOW]) {
      ...
      if (this.graph.isWrapping(a.cell) && (2 <= this.bounds.width || 2 <= this.bounds.height)) if (this.textarea.style.wordWrap = mxConstants.WORD_WRAP, this.textarea.style.whiteSpace = 'normal', this.textarea.innerHTML != this.getEmptyLabelText()) if (f = Math.round(this.bounds.width / c) + this.wordWrapPadding, 'relative' != this.textarea.style.position) this.textarea.style.width = f + 'px',
      this.textarea.scrollWidth > f && (this.textarea.style.width = this.textarea.scrollWidth + 'px');
       else if ('block' == a.style[mxConstants.STYLE_OVERFLOW] || 'width' == a.style[mxConstants.STYLE_OVERFLOW]) {
        if ( - 0.5 == d.y || 'width' == a.style[mxConstants.STYLE_OVERFLOW]) this.textarea.style.maxHeight = this.bounds.height + 'px';
        this.textarea.style.width = f + 'px'
      } else this.textarea.style.maxWidth = f + 'px';
       else this.textarea.style.maxWidth = f + 'px';
       else this.textarea.style.whiteSpace = 'nowrap',
      this.textarea.style.width = '';
      8 == document.documentMode && (this.textarea.style.zoom = '1', this.textarea.style.height = 'auto');
      8 == document.documentMode ? (a = this.textarea.scrollWidth, e = this.textarea.scrollHeight, this.textarea.style.left = Math.max(0, Math.ceil((this.bounds.x - d.x * (this.bounds.width - (a + 1) * c) + a * (c - 1) * 0 + 2 * (d.x + 0.5)) / c)) + 'px', this.textarea.style.top = Math.max(0, Math.ceil((this.bounds.y -
      d.y * (this.bounds.height - (e + 0.5) * c) + e * (c - 1) * 0 + 1 * Math.abs(d.y + 0.5)) / c)) + 'px', this.textarea.style.width = Math.round(a * c) + 'px', this.textarea.style.height = Math.round(e * c) + 'px') : (this.textarea.style.left = Math.max(0, Math.round(this.bounds.x - d.x * (this.bounds.width - 2)) + 1) + 'px', this.textarea.style.top = Math.max(0, Math.round(this.bounds.y - d.y * (this.bounds.height - 4) + ( - 1 == d.y ? 3 : 0)) + 1) + 'px')
    } else this.bounds = this.getEditorBounds(a),
    this.textarea.style.width = Math.round(this.bounds.width / c) + 'px',
    this.textarea.style.height = Math.round(this.bounds.height / c) + 'px',
    8 == document.documentMode ? (this.textarea.style.left = Math.round(this.bounds.x) + 'px', this.textarea.style.top = Math.round(this.bounds.y) + 'px') : (this.textarea.style.left = Math.max(0, Math.round(this.bounds.x + 1)) + 'px', this.textarea.style.top = Math.max(0, Math.round(this.bounds.y + 1)) + 'px'),
  ...
  if (null != this.editingCell) {
    ...
    if (null != a && (this.textarea.innerHTML != b || null != this.align)) {
      ...
      try {
        ...
        null != this.align && this.graph.setCellStyles(mxConstants.STYLE_ALIGN, this.align, [
          a.cell
        ])
      } finally {
...
mxCellRenderer.prototype.checkPlaceholderStyles = function (a) {
  ...
  ], d = 0; d < c.length; d++) if (0 <= mxUtils.indexOf(b, a.style[c[d]])) return !0;
  return !1
};
...
mxCellRenderer.prototype.createLabel = function (a, b) {
  ...
  if (0 < a.style[mxConstants.STYLE_FONTSIZE] || null == a.style[mxConstants.STYLE_FONTSIZE]) {
    ...
    f = function (g) {
      var k = a;
      if (mxClient.IS_TOUCH || e) k = mxEvent.getClientX(g),
      g = mxEvent.getClientY(g),
      g = mxUtils.convertPoint(c.container, k, g),
      k = c.view.getState(c.getCellAt(g.x, g.y));
      return k
    };
...
mxCellRenderer.prototype.createCellOverlays = function (a) {
  ...
  null !=
  a.overlays && a.overlays.visit(function (f, g) {
    g.destroy()
  });
  a.overlays = c
};
...
mxCellRenderer.prototype.installListeners = function (a) {
  ...
  c = function (d) {
    var e = a;
    if (b.dialect != mxConstants.DIALECT_SVG && 'IMG' == mxEvent.getSource(d).nodeName || mxClient.IS_TOUCH) e = mxEvent.getClientX(d),
    d = mxEvent.getClientY(d),
    d = mxUtils.convertPoint(b.container, e, d),
    e = b.view.getState(b.getCellAt(d.x, d.y));
    return e
  };
...
mxCellRenderer.prototype.redrawLabel = function (a, b) {
  ...
  if (null != a.text) {
    ...
    if (b || a.text.value != d || a.text.isWrapping != e || a.text.overflow != k || a.text.isClipping != f || a.text.scale != l || a.text.dialect != g || null == a.text.bounds || !a.text.bounds.equals(c)) a.text.dialect = g,
    a.text.value = d,
    a.text.bounds = c,
    a.text.scale = l,
    a.text.wrap = e,
    a.text.clipped = f,
    a.text.overflow = k,
    b = a.text.node.style.visibility,
    this.redrawLabelShape(a.text),
    a.text.node.style.visibility = b
  }
};
...
mxCellRenderer.prototype.redrawCellOverlays = function (a, b) {
  ...
  if (null != a.overlays) {
    ...
    a.overlays.visit(function (g, k) {
      ...
      if (b || null == k.bounds || k.scale != a.view.scale || !k.bounds.equals(g)) k.bounds = g,
...
var mxEdgeStyle = {
  ...
  ElbowConnector: function (a, b, c, d, e) {
    ...
    g = l == m,
    g || (k = Math.max(b.y, c.y), n = Math.min(b.y + b.height, c.y + c.height), k = k == n);
  ...
  SegmentConnector: function (a, b, c, d, e) {
    ...
    if (null != d && 0 < d.length) {
      ...
      for (q = 0; 2 > q; q++) {
        ...
        B = null != t && x.x >= t.x && x.x <= t.x + t.width;
        t = C || null == u && A;
        x = y || null == u && B;
        if (0 != q || !(t && x || y && C)) {
          if (null != u && !C && !y && (A || B)) {
    ...
    if (null ==
    f[n] && null != g) for (; 0 < c.length && null != c[c.length - 1] && mxUtils.contains(g, c[c.length - 1].x, c[c.length - 1].y); ) c.splice(c.length - 1, 1);
    for (q = 0; q < c.length; q++) if (f = c[q], f.x = Math.round(f.x * a.view.scale * 10) / 10, f.y = Math.round(f.y * a.view.scale * 10) / 10, null == k || 1 <= Math.abs(k.x - f.x) || Math.abs(k.y - f.y) >= Math.max(1, a.view.scale)) e.push(f),
    k = f;
    null != r && null != e[e.length - 1] && 1 >= Math.abs(r.x - e[e.length - 1].x) && 1 >= Math.abs(r.y - e[e.length - 1].y) && (e.splice(e.length - 1, 1), null != e[e.length - 1] && (1 > Math.abs(e[e.length - 1].x - r.x) && (e[e.length - 1].x = r.x), 1 > Math.abs(e[e.length - 1].y - r.y) && (e[e.length - 1].y = r.y)))
  },
  orthBuffer: 10,
  ...
  getJettySize: function (a, b) {
    ...
    'auto' == c && (mxUtils.getValue(a.style, b ? mxConstants.STYLE_STARTARROW : mxConstants.STYLE_ENDARROW, mxConstants.NONE) != mxConstants.NONE ? (a = mxUtils.getNumber(a.style, b ? mxConstants.STYLE_STARTSIZE :
    mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE), c = Math.max(2, Math.ceil((a + mxEdgeStyle.orthBuffer) / mxEdgeStyle.orthBuffer)) * mxEdgeStyle.orthBuffer) : c = 2 * mxEdgeStyle.orthBuffer);
    return c
  },
  ...
  OrthConnector: function (a, b, c, d, e) {
    ...
    var B = mxEdgeStyle.getJettySize(a, !1);
    null != l && m == l && (f = B = Math.max(f, B));
    var z = B + f,
    v = !1;
    if (null != n && null != p) {
      v = p.x - n.x;
    ...
    if (v || mxEdgeStyle.orthPointsFallback && null != d && 0 < d.length || g || k) mxEdgeStyle.SegmentConnector(a, b, c, d, e);
      ...
      null != l && (c[0] = mxUtils.getPortConstraints(l, a, !0, mxConstants.DIRECTION_MASK_ALL), b = mxUtils.getValue(l.style, mxConstants.STYLE_ROTATION, 0), 0 != b && (b = mxUtils.getBoundingBox(new mxRectangle(q, r, t, u), b), q = b.x, r = b.y, t = b.width, u = b.height));
      null != m && (c[1] = mxUtils.getPortConstraints(m, a, !1, mxConstants.DIRECTION_MASK_ALL), b = mxUtils.getValue(m.style, mxConstants.STYLE_ROTATION, 0), 0 != b && (b = mxUtils.getBoundingBox(new mxRectangle(x, y, C, A), b), x = b.x, y = b.y, C = b.width, A = b.height));
      b = [
        0,
        0
      ];
      ...
      for (v = 0; 2 > v; v++) mxEdgeStyle.limits[v][1] = q[v][0] - B[v],
      mxEdgeStyle.limits[v][2] = q[v][1] - B[v],
      mxEdgeStyle.limits[v][4] = q[v][0] + q[v][2] + B[v],
      mxEdgeStyle.limits[v][8] = q[v][1] + q[v][3] + B[v];
      B = q[0][1] + q[0][3] / 2;
      r = q[1][1] + q[1][3] / 2;
      v = q[0][0] + q[0][2] / 2 - (q[1][0] + q[1][2] / 2);
      D = B - r;
      B = 0;
      0 > v ? B = 0 > D ? 2 : 1 : 0 >= D && (B = 3, 0 == v && (B = 2));
      r = null;
      null != l && (r = n);
      l = [
        [0.5,
      ...
      1 >= Math.abs(r.y - q[v][1] - q[v][3]) && (b[v] = mxConstants.DIRECTION_MASK_SOUTH)),
      r = null,
      null != m && (r = p);
      v = q[0][1] - (q[1][1] + q[1][3]);
      p = q[0][0] - (q[1][0] + q[1][2]);
      r = q[1][1] - (q[0][1] + q[0][3]);
      t = q[1][0] - (q[0][0] + q[0][2]);
      mxEdgeStyle.vertexSeperations[1] = Math.max(p - z, 0);
      mxEdgeStyle.vertexSeperations[2] = Math.max(v - z, 0);
      mxEdgeStyle.vertexSeperations[4] = Math.max(r - z, 0);
      mxEdgeStyle.vertexSeperations[3] = Math.max(t - z, 0);
      z = [
      ];
      m = [
      ];
      ...
      for (v = 0; 2 > v; v++) 0 == b[v] && (0 == (t[v][0] & c[v]) && (t[v][0] = t[v][1]), z[v] = t[v][0] & c[v], z[v] |= (t[v][1] & c[v]) << 8, z[v] |= (t[1 - v][v] & c[v]) << 16, z[v] |= (t[1 - v][1 - v] & c[v]) << 24, 0 == (z[v] & 15) && (z[v] <<= 8), 0 == (z[v] & 3840) && (z[v] = z[v] & 15 | z[v] >> 8), 0 == (z[v] & 983040) && (z[v] = z[v] & 65535 | (z[v] & 251658240) >> 8), b[v] = z[v] & 15, c[v] == mxConstants.DIRECTION_MASK_WEST || c[v] == mxConstants.DIRECTION_MASK_NORTH || c[v] == mxConstants.DIRECTION_MASK_EAST || c[v] == mxConstants.DIRECTION_MASK_SOUTH) && (b[v] = c[v]);
      c = b[0] == mxConstants.DIRECTION_MASK_EAST ? 3 : b[0];
      z = b[1] == mxConstants.DIRECTION_MASK_EAST ? 3 : b[1];
      c -= B;
      z -= B;
      1 > c && (c += 4);
      1 > z && (z += 4);
      c = mxEdgeStyle.routePatterns[c - 1][z - 1];
      ...
      f = 0;
      m = z = 0 < (b[0] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1;
      for (v = 0; v < c.length; v++) n = c[v] & 15,
      u = n == mxConstants.DIRECTION_MASK_EAST ?
      3 : n,
      u += B,
      4 < u && (u -= 4),
      p = mxEdgeStyle.dirVectors[u - 1],
      n = 0 < u % 2 ? 0 : 1,
      n != z && (f++, mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f - 1][0], mxEdgeStyle.wayPoints1[f][1] = mxEdgeStyle.wayPoints1[f - 1][1]),
      x = 0 < (c[v] & mxEdgeStyle.TARGET_MASK),
      y = 0 < (c[v] & mxEdgeStyle.SOURCE_MASK),
      r = (c[v] & mxEdgeStyle.SIDE_MASK) >> 5,
      r <<= B,
      15 < r && (r >>= 4),
      t = 0 < (c[v] & mxEdgeStyle.CENTER_MASK),
      (y || x) && 9 > r ? (u = y ? 0 : 1, r = t && 0 == n ? q[u][0] + l[u][0] * q[u][2] : t ? q[u][1] + l[u][1] * q[u][3] : mxEdgeStyle.limits[u][r], 0 == n ? (r = (r - mxEdgeStyle.wayPoints1[f][0]) * p[0], 0 < r && (mxEdgeStyle.wayPoints1[f][0] += p[0] * r)) : (r = (r - mxEdgeStyle.wayPoints1[f][1]) * p[1], 0 < r && (mxEdgeStyle.wayPoints1[f][1] += p[1] * r))) : t && (mxEdgeStyle.wayPoints1[f][0] += p[0] * Math.abs(mxEdgeStyle.vertexSeperations[u] / 2), mxEdgeStyle.wayPoints1[f][1] += p[1] * Math.abs(mxEdgeStyle.vertexSeperations[u] / 2)),
      0 < f && mxEdgeStyle.wayPoints1[f][n] == mxEdgeStyle.wayPoints1[f - 1][n] ? f-- : z = n;
      for (v = 0; v <= f && (v != f || ((0 < (b[1] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1) == m ? 0 : 1) == (f + 1) % 2); v++) e.push(new mxPoint(Math.round(mxEdgeStyle.wayPoints1[v][0] * a.view.scale * 10) / 10, Math.round(mxEdgeStyle.wayPoints1[v][1] * a.view.scale * 10) / 10));
...
mxGraphView.prototype.scaleAndTranslate = function (a, b, c) {
  ...
  this.translate.x = b,
  this.translate.y = c,
  this.isEventsEnabled() && this.viewStateChanged();
...
mxGraphView.prototype.validateCell = function (a, b) {
  if (null != a) if (b = (null != b ? b : !0) && this.graph.isCellVisible(a), null == this.getState(a, b) || b) for (var c = this.graph.getModel(), d = c.getChildCount(a), e = 0; e < d; e++) this.validateCell(c.getChildAt(a, e), b && (!this.isCellCollapsed(a) || a == this.currentRoot));
...
mxGraphView.prototype.validateCellState = function (a, b) {
  ...
  if (null != a && (c = this.getState(a), null != c)) {
    ...
    if (c.invalid) {
      c.invalid = !1;
      if (null == c.style || c.invalidStyle) c.style = this.graph.getCellStyle(c.cell),
      c.invalidStyle = !1;
    ...
    if (b && !c.invalid) {
      ...
      b = d.getChildCount(a);
      for (var e = 0; e < b; e++) this.validateCellState(d.getChildAt(a, e))
    }
  }
  return c
};
...
mxGraphView.prototype.getVisibleTerminal = function (a, b) {
  ...
  for (b = a = c.getTerminal(a, b); null != a && a != this.currentRoot; ) {
    if (!this.graph.isCellVisible(b) || this.isCellCollapsed(a)) b = a;
    a = c.getParent(a)
  }
...
mxGraphView.prototype.getPoint = function (a, b) {
  var c = a.getCenterX(),
  d = a.getCenterY();
  if (null == a.segments || null != b && !b.relative) null != b && (b = b.offset, null != b && (c += b.x, d += b.y));
   else {
    for (var e = a.absolutePoints.length, f = Math.round(((null != b ? b.x / 2 : 0) + 0.5) * a.length), g = a.segments[0], k = 0, l = 1; f >= Math.round(k + g) && l < e - 1; ) k += g,
    g = a.segments[l++];
    e = 0 == g ? 0 : (f - k) / g;
...
mxGraphView.prototype.getRelativePoint = function (a, b, c) {
  ...
  if (null != d) {
    ...
    if (d.relative && 1 < e) {
      d = a.length;
      for (var f = a.segments, g = a.absolutePoints[0], k = a.absolutePoints[1], l = mxUtils.ptSegDistSq(g.x, g.y, k.x, k.y, b, c), m = 0, n = 0, p = 0, q = 2; q < e; q++) g = k,
...
mxGraph.prototype.getSelectionCellsForChanges = function (a, b) {
  for (var c = new mxDictionary, d = [
  ], e = mxUtils.bind(this, function (l) {
    if (!c.get(l) && this.model.contains(l)) if (this.model.isEdge(l) || this.model.isVertex(l)) c.put(l, !0),
    d.push(l);
     else for (var m = this.model.getChildCount(l), n = 0; n < m; n++) e(this.model.getChildAt(l, n))
  }), f = 0; f < a.length; f++) {
    var g = a[f];
...
mxGraph.prototype.updateSelection = function () {
  for (var a = this.getSelectionCells(), b = [
  ], c = 0; c < a.length; c++) if (this.model.contains(a[c]) && this.isCellVisible(a[c])) for (var d = this.model.getParent(a[c]); null != d && d != this.view.currentRoot; ) {
...
mxGraph.prototype.processChange = function (a) {
  ...
  this.fireEvent(new mxEventObject(mxEvent.ROOT));
    ...
    if (!this.model.contains(b) || this.isCellCollapsed(b)) this.view.invalidate(a.child, !0, !0),
...
mxGraph.prototype.setCellWarning = function (a, b, c, d) {
  ...
  d && b.addListener(mxEvent.CLICK, mxUtils.bind(this, function (e, f) {
...
mxGraph.prototype.updatePageBreaks = function (a, b, c) {
  ...
  a = mxUtils.bind(this, function (n) {
    if (null != n) {
      for (var p = n == this.horizontalPageBreaks ? g : k, q = 0; q <= p; q++) {
        var r = n == this.horizontalPageBreaks ? [
          new mxPoint(Math.round(f.x), Math.round(f.y + q * f.height)),
          new mxPoint(Math.round(f.x +
          l), Math.round(f.y + q * f.height))
        ] : [
          new mxPoint(Math.round(f.x + q * f.width), Math.round(f.y)),
          new mxPoint(Math.round(f.x + q * f.width), Math.round(f.y + m))
        ];
        null != n[q] ? (n[q].points = r, n[q].redraw()) : (r = new mxPolyline(r, this.pageBreakColor), r.dialect = this.dialect, r.pointerEvents = !1, r.isDashed = this.pageBreakDashed, r.init(this.view.backgroundPane), r.redraw(), n[q] = r)
      }
      for (q = p; q < n.length; q++) n[q].destroy();
...
mxGraph.prototype.getCellStyle = function (a, b) {
  ...
  var d = this.model.isEdge(a) ? this.stylesheet.getDefaultEdgeStyle() : this.stylesheet.getDefaultVertexStyle();
  null != c ? d = this.stylesheet.getCellStyle(c, d, b) : null != d && (d = mxUtils.clone(d));
  null == d ? d = {
  }
   : b && (d = this.postProcessCellStyle(a, d));
  return d
};
...
mxGraph.prototype.toggleCellStyle = function (a, b, c) {
  ...
  return this.toggleCellStyles(a, b, [
    c
  ])
};
...
mxGraph.prototype.alignCells = function (a, b, c) {
  ...
  if (null != b && 1 < b.length) {
    ...
    if (null != c) {
      ...
      this.model.beginUpdate();
      try {
        for (d = 0; d < b.length; d++) e = this.getOriginForCell(b[d]),
        f = this.getCellGeometry(b[d]),
        this.model.isEdge(b[d]) || null == f || f.relative || (f = f.clone(), a == mxConstants.ALIGN_CENTER ? f.x = c - e.x - f.width / 2 : a == mxConstants.ALIGN_RIGHT ? f.x = c - e.x - f.width : a == mxConstants.ALIGN_TOP ? f.y = c - e.y : a == mxConstants.ALIGN_MIDDLE ? f.y = c - e.y - f.height / 2 : a == mxConstants.ALIGN_BOTTOM ? f.y = c - e.y - f.height : f.x = c - e.x, this.resizeCell(b[d], f));
...
mxGraph.prototype.removeImageBundle = function (a) {
  for (var b = [
  ], c = 0; c < this.imageBundles.length; c++) this.imageBundles[c] != a && b.push(this.imageBundles[c]);
  this.imageBundles = b
};
    ...
    try {
      for (var c = 0; c < a.length; c++) {
        ...
        if (null != d && 0 < d.length) {
          ...
          b = b.concat(d);
          for (var g = 0; g < d.length; g++) if (this.model.isVertex(d[g])) {
...
mxGraph.prototype.getCellsForUngroup = function () {
  for (var a = this.getEditableCells(this.getSelectionCells()), b = [
  ], c = 0; c < a.length; c++) this.model.isVertex(a[c]) && 0 < this.model.getChildCount(a[c]) && b.push(a[c]);
  return b
};
...
mxGraph.prototype.cloneCells = function (a, b, c, d) {
  ...
  if (null != a) {
    ...
    for (var g = 0; g < a.length; g++) f.put(a[g], !0),
    e.push(a[g]);
    if (0 < e.length) {
      var k = this.view.scale,
      l = this.view.translate;
      e = this.model.cloneCells(a, !0, c);
      for (g = 0; g < a.length; g++) if (!b && this.model.isEdge(e[g]) && null != this.getEdgeValidationError(e[g], this.model.getTerminal(e[g], !0), this.model.getTerminal(e[g], !1))) e[g] = null;
       else {
        ...
        if (null != m) {
          ...
          if (null != n && null != p) if (c = d ? 0 : p.origin.x, p = d ? 0 : p.origin.y, this.model.isEdge(e[g])) {
            if (n = n.absolutePoints, null != n) {
              ...
              var r = n.length - 1;
              null == q && null != n[r] && m.setTerminalPoint(new mxPoint(n[r].x / k - l.x, n[r].y / k - l.y), !1);
              m = m.points;
              if (null != m) for (n = 0; n < m.length; n++) m[n].x += c,
              m[n].y += p
            }
...
mxGraph.prototype.cellsAdded = function (a, b, c, d, e, f, g, k) {
  if (null != a && null != b && null != c) {
    ...
    try {
      ...
      n = new mxPoint(0, 0);
      for (l = 0; l < a.length; l++) if (null == a[l]) c--;
       else {
...
mxGraph.prototype.autoSizeCell = function (a, b) {
  if (null != b ? b : 1) {
    ...
    for (var c = 0; c < b; c++) this.autoSizeCell(this.model.getChildAt(a, c))
  }
    ...
    try {
      ...
      for (e = 0; e < a.length; e++) {
        for (var f = this.getAllEdges([a[e]]), g = mxUtils.bind(this, function (l, m) {
          ...
          if (null != n) {
            for (var p = this.model.getTerminal(l, m), q = !1, r = p; null != r; ) {
              if (a[e] == r) {
                q = !0;
                break
              }
  ...
  try {
    if (null == c) {
      ...
      if (null != m && null != m.points && null != l) {
        ...
        null != m && null != m.points && (m = m.clone(), m.points = m.points.slice(q), this.model.setGeometry(a, m))
      }
    }
      ...
      if (null != d) {
        ...
        if (null != g) {
          ...
          if (this.isSwimlane(a)) {
            ...
            'fixed' ==
            m.style[mxConstants.STYLE_ASPECT] && (g.height = Math.round(d.height * g.width * 100 / d.width) / 100);
          ...
          if (!b && !k) {
            var q = this.view.getBounds(this.model.getChildren(a));
            if (null != q) {
              var r = this.view.translate,
              t = this.view.scale,
              u = (q.x + q.width) / t - d.x - r.x;
              d.height = Math.max(d.height, (q.y + q.height) / t - d.y - r.y);
...
mxGraph.prototype.getPreferredSizeForCell = function (a, b) {
  ...
  if (null != a) {
    ...
    if (!this.model.isEdge(a)) {
      ...
      a = c = 0;
      null == this.getImage(d) && null == e[mxConstants.STYLE_IMAGE] || e[mxConstants.STYLE_SHAPE] != mxConstants.SHAPE_LABEL || (e[mxConstants.STYLE_VERTICAL_ALIGN] == mxConstants.ALIGN_MIDDLE && (c += parseFloat(mxUtils.getValue(e, mxConstants.STYLE_IMAGE_WIDTH, mxLabel.prototype.imageSize))), e[mxConstants.STYLE_ALIGN] !=
      mxConstants.ALIGN_CENTER && (a += parseFloat(mxUtils.getValue(e, mxConstants.STYLE_IMAGE_HEIGHT, mxLabel.prototype.imageSize))));
      ...
      this.gridSize / 2)), c = new mxRectangle(0, 0, b, d)) : (e = 4 * this.gridSize, c = new mxRectangle(0, 0, e, e))
    }
  }
  return c
};
mxGraph.prototype.resizeCell = function (a, b, c) {
  return this.resizeCells([a], [
    b
  ], c) [0]
};
...
mxGraph.prototype.cellsResized = function (a, b, c) {
  ...
  if (null != a && null != b && a.length == b.length) {
    this.model.beginUpdate();
    try {
      for (var e = 0; e < a.length; e++) d.push(this.cellResized(a[e], b[e], !1, c)),
      this.isExtendParent(a[e]) && this.extendParent(a[e]),
      this.constrainChild(a[e]);
...
mxGraph.prototype.resizeChildCells = function (a, b) {
  ...
  c = this.model.getChildCount(a);
  for (var e = 0; e < c; e++) this.scaleCell(this.model.getChildAt(a, e), d, b, !0)
};
...
mxGraph.prototype.extendParent = function (a) {
  if (null != a) {
    ...
    null == b || null == c || this.isCellCollapsed(b) || (a = this.getCellGeometry(a), null != a && !a.relative && (c.width < a.x + a.width || c.height < a.y + a.height) && (c = c.clone(), c.width = Math.max(c.width, a.x + a.width), c.height = Math.max(c.height, a.y + a.height), this.cellsResized([b], [
      c
    ], !1)))
  }
};
  ...
  if (null != a && (0 != b || 0 != c || d || null != e)) {
    ...
    try {
      ...
      for (m = 0; m < a.length; m++) {
        ...
        null != q && q.relative && this.model.isEdge(r) && (n(this.model.getTerminal(r, !0)) || n(this.model.getTerminal(r, !1))) || p.push(a[m])
      }
      a = p;
      ...
      if (null != e) {
        ...
        if (d) for (m = 0; m < a.length; m++) q = this.getCellGeometry(a[m]),
        r = this.model.getParent(k[m]),
        null != q && q.relative && this.model.isEdge(r) && this.model.contains(r) && this.model.add(r, a[m])
      }
    ...
    if (null != b && b != this.getDefaultParent()) {
      ...
      if (null != c) {
        ...
        if (this.isSwimlane(b)) {
          ...
          if (b ==
          mxConstants.DIRECTION_SOUTH || b == mxConstants.DIRECTION_NORTH) {
            var l = f.width;
            f.width = f.height;
            f.height = l
          }
          if (b == mxConstants.DIRECTION_EAST && !g || b == mxConstants.DIRECTION_NORTH && !k || b == mxConstants.DIRECTION_WEST && g || b == mxConstants.DIRECTION_SOUTH && k) a = f.width,
          d = f.height;
          e -= f.width;
          c -= f.height
        }
...
mxGraph.prototype.constrainChild = function (a, b) {
  if (null != a && (b = this.getCellGeometry(a), null != b && (this.isConstrainRelativeChildren() || !b.relative))) {
    ...
    if (this.isConstrainChild(a) && (c = this.getCellContainmentArea(a), null != c)) {
      ...
      0 < e && (c = mxRectangle.fromRectangle(c), c.x -= c.width * e, c.y -=
      c.height * e, c.width += 2 * c.width * e, c.height += 2 * c.height * e);
    ...
    if (null != d) {
      ...
      if (!this.isCellCollapsed(a)) {
        ...
        for (var f = 0; f < e.length; f++) this.isCellVisible(e[f]) && c.push(e[f])
      }
      ...
      if (null != c) {
        ...
        c.y + c.height >
        d.y + d.height && (f -= c.y + c.height - d.y - d.height - f);
        c.x < d.x && (e -= c.x - d.x);
        c.y < d.y && (f -= c.y - d.y);
        if (0 != e || 0 != f) b.relative ? (null == b.offset && (b.offset = new mxPoint), b.offset.x += e, b.offset.y += f) : (b.x += e, b.y += f);
...
mxGraph.prototype.resetEdge = function (a) {
  ...
  null != b && null != b.points && 0 < b.points.length && (b = b.clone(), b.points = [
  ], this.model.setGeometry(a, b));
  return a
};
...
mxGraph.prototype.setConnectionConstraint = function (a, b, c, d) {
  if (null != d) {
    this.model.beginUpdate();
    try {
      null == d || null == d.point ? (this.setCellStyles(c ? mxConstants.STYLE_EXIT_X : mxConstants.STYLE_ENTRY_X, null, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_Y : mxConstants.STYLE_ENTRY_Y, null, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_DX : mxConstants.STYLE_ENTRY_DX, null, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_DY : mxConstants.STYLE_ENTRY_DY, null, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_PERIMETER :
      mxConstants.STYLE_ENTRY_PERIMETER, null, [
        a
      ])) : null != d.point && (this.setCellStyles(c ? mxConstants.STYLE_EXIT_X : mxConstants.STYLE_ENTRY_X, d.point.x, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_Y : mxConstants.STYLE_ENTRY_Y, d.point.y, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_DX : mxConstants.STYLE_ENTRY_DX, d.dx, [
        a
      ]), this.setCellStyles(c ? mxConstants.STYLE_EXIT_DY : mxConstants.STYLE_ENTRY_DY, d.dy, [
        a
      ]), d.perimeter ? this.setCellStyles(c ? mxConstants.STYLE_EXIT_PERIMETER : mxConstants.STYLE_ENTRY_PERIMETER, null, [
        a
      ]) : this.setCellStyles(c ? mxConstants.STYLE_EXIT_PERIMETER : mxConstants.STYLE_ENTRY_PERIMETER, '0', [
        a
      ]))
    } finally {
      this.model.endUpdate()
...
mxGraph.prototype.getConnectionPoint = function (a, b, c) {
  ...
  if (null != a && null != b.point) {
    ...
    if (b.perimeter) 0 != k && (g = e = 0, 90 == k ? g = 1 : 180 == k ? e = - 1 : 270 == k && (g = - 1), d = mxUtils.getRotatedPoint(d, e, g, f)),
    d = this.view.getPerimeterPoint(a, d, !1);
      ...
      if (g == mxConstants.DIRECTION_NORTH || g == mxConstants.DIRECTION_SOUTH) a = k,
      k = b,
      b = a;
...
mxGraph.prototype.cellConnected = function (a, b, c, d) {
  if (null != a) {
    ...
    try {
      ...
      this.isPortsEnabled() && (d = null, this.isPort(b) && (d = b.getId(), b = this.getTerminalForPort(b, c)), this.setCellStyles(c ? mxConstants.STYLE_SOURCE_PORT : mxConstants.STYLE_TARGET_PORT, d, [
        a
      ]));
  ...
  this.container.scrollTop = - b;
    ...
    if (this.dialect == mxConstants.DIALECT_SVG) if (0 == a && 0 == b) {
      ...
      if (null == this.shiftPreview1) {
        ...
        for (d = this.container.firstChild; null != d; ) e = d.nextSibling,
...
mxGraph.prototype.zoom = function (a, b, c) {
  ...
  a = d / this.view.scale;
  if (this.keepSelectionVisibleOnZoom && null != c) a = new mxRectangle(c.x * a, c.y * a, c.width * a, c.height * a),
  this.view.scale = d,
...
mxGraph.prototype.getSwimlaneDirection = function (a) {
  ...
  mxConstants.DIRECTION_WEST][mxUtils.mod(a, 4)]
};
...
mxGraph.prototype.getEdges = function (a, b, c, d, e, f) {
  ...
  f = null != f ? f : !1;
  for (var g = [
  ], k = this.isCellCollapsed(a), l = this.model.getChildCount(a), m = 0; m < l; m++) {
...
mxGraph.prototype.traverse = function (a, b, c, d, e, f) {
  if (null != c && null != a && (b = null != b ? b : !0, f = null != f ? f : !1, e = e || new mxDictionary, null == d || !e.get(d)) && (e.put(d, !0), d = c(a, d), null == d || d) && (d = this.model.getEdgeCount(a), 0 < d)) for (var g = 0; g < d; g++) {
...
mxGraph.prototype.createHandler = function (a) {
  var b = null;
  if (null != a) if (this.model.isEdge(a.cell)) {
...
mxGraph.prototype.isEventIgnored = function (a, b, c) {
  ...
  if (null != this.eventSource && a != mxEvent.MOUSE_MOVE) mxEvent.removeGestureListeners(this.eventSource, null, this.mouseMoveRedirect, this.mouseUpRedirect),
...
mxGraph.prototype.fireMouseEvent = function (a, b, c) {
  if (this.isEventSourceIgnored(a, b)) null != this.tooltipHandler && this.tooltipHandler.hide();
    ...
    if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && (mxEvent.isTouchEvent(b.getEvent()) || mxEvent.isPenEvent(b.getEvent()))) {
      ...
      if (a == mxEvent.MOUSE_DOWN) if (null != this.lastTouchEvent && this.lastTouchEvent != b.getEvent() && d - this.lastTouchTime < this.doubleTapTimeout && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance && 2 > this.doubleClickCounter) {
    ...
    if (!this.isEventIgnored(a, b, c)) {
      ...
      if (mxClient.IS_OP || mxClient.IS_SF || mxClient.IS_GC || mxClient.IS_IE11 || mxClient.IS_IE && mxClient.IS_SVG || b.getEvent().target != this.container) {
        ...
        if (null != this.mouseListeners) for (d = [
          c,
          b
...
mxCellOverlay.prototype.getBounds = function (a) {
  ...
  d = this.image.width,
  e = this.image.height;
  if (b) if (b = a.absolutePoints, 1 == b.length % 2) b = b[Math.floor(b.length / 2)];
   else {
    var f = b.length / 2;
    a = b[f - 1];
    b = b[f];
  ...
  b.x = this.align == mxConstants.ALIGN_LEFT ? a.x : this.align == mxConstants.ALIGN_CENTER ? a.x + a.width / 2 : a.x + a.width,
  b.y = this.verticalAlign == mxConstants.ALIGN_TOP ? a.y : this.verticalAlign == mxConstants.ALIGN_MIDDLE ?
...
mxOutline.prototype.addGestureListeners = function (a) {
  ...
  f = mxUtils.bind(this, function (l) {
    if (this.isEnabled()) {
      ...
      if (mxEvent.getSource(l) != this.viewport) if (this.isScrolling()) {
        m -= p.width / e;
        n -= p.height / e;
        var q = this.svg.getBoundingClientRect();
        this.source.container.scrollLeft = p.x - m * e / 2 + (b.x - this.border - q.left) * e;
        this.source.container.scrollTop = p.y - n * e / 2 + (b.y - this.border - q.top) * e
      } else p = this.source.view.translate,
      n = this.viewport.getBoundingClientRect(),
      m = (mxEvent.getClientX(l) - n.left) * e / this.source.view.scale,
      n = (mxEvent.getClientY(l) - n.top) * e / this.source.view.scale,
  ...
  k = mxUtils.bind(this, function (l) {
    if (this.isEnabled() && null != b) {
      if (!this.isScrolling()) {
        ...
        this.source.getView().setTranslate(p.x -
        m, p.y - n);
        this.source.panGraph(0, 0)
      }
...
function mxTemporaryCellStates(a, b, c, d, e, f) {
  ...
  null != e && (a.graph.cellRenderer.doRedrawShape = function (m) {
    ...
    m.shape.paint = function (p) {
      var q = e(m);
      null != q && p.setLink(q, null != f ? f(m) : null);
      n.apply(this, arguments);
      null != q && p.setLink(null)
    };
...
mxCellStatePreview.prototype.translateState = function (a, b, c) {
  if (null != a) {
    ...
    for (var f = 0; f < e; f++) this.translateState(a.view.getState(d.getChildAt(a.cell, f)), b, c)
  }
};
...
mxGraphHandler.prototype.getInitialCellForEvent = function (a) {
  var b = a.getState();
  if (!(this.graph.isToggleEvent(a.getEvent()) && mxEvent.isAltDown(a.getEvent()) || null == b || this.graph.isCellSelected(b.cell))) for (var c = this.graph.model, d = this.graph.view.getState(c.getParent(b.cell)); null != d && !this.graph.isCellSelected(d.cell) && (c.isVertex(d.cell) || c.isEdge(d.cell)) && this.isPropagateSelectionCell(b.cell, !0, a); ) b = d,
  d = this.graph.view.getState(this.graph.getModel().getParent(b.cell));
...
mxGraphHandler.prototype.selectCellForEvent = function (a, b) {
  ...
  if (null != c) {
    if (!(b.isSource(c.control) || this.graph.isToggleEvent(b.getEvent()) && mxEvent.isAltDown(b.getEvent()))) {
      c = this.graph.getModel();
      for (var d = c.getParent(a); null != this.graph.view.getState(d) && (c.isVertex(d) || c.isEdge(d) && !this.graph.isToggleEvent(b.getEvent())) && this.isPropagateSelectionCell(a, !1, b); ) a = d,
      d = c.getParent(a)
    }
...
mxGraphHandler.prototype.start = function (a, b, c, d) {
  ...
  if (this.guidesEnabled) {
    ...
    for (b = 0; b < a.length; b++) c = this.graph.view.getState(a[b]),
    null == c || g.get(c) || g.put(c, !0);
...
mxGraphHandler.prototype.addStates = function (a, b) {
  ...
  if (null != c && null == b.get(a)) {
    ...
    for (var e = 0; e < c; e++) d += this.addStates(this.graph.model.getChildAt(a, e), b)
  }
  return d
};
...
mxGraphHandler.prototype.mouseMove = function (a, b) {
  ...
  if (b.isConsumed() || !a.isMouseDown || null == this.cell || null == this.first || null == this.bounds || this.suspended) !this.isMoveEnabled() && !this.isCloneEnabled() || !this.updateCursor || b.isConsumed() || null == b.getState() && null == b.sourceState || a.isMouseDown || (c = a.getCursorForMouseEvent(b), null == c && a.isEnabled() && a.isCellMovable(b.getCell()) && (c = a.getModel().isEdge(b.getCell()) ? mxConstants.CURSOR_MOVABLE_EDGE : mxConstants.CURSOR_MOVABLE_VERTEX), null != c && null != b.sourceState && b.sourceState.setCursor(c));
    ...
    if (null != this.shape || this.livePreviewActive || Math.abs(c.x) > d || Math.abs(c.y) > d) {
      ...
      f = b.getCell();
      f = null != f && 0 > mxUtils.indexOf(this.cells, f) ? f : a.getCellAt(b.getGraphX(), b.getGraphY(), null, null, null, mxUtils.bind(this, function (n, p, q) {
      ...
      this.isConstrainedEvent(b) && (Math.abs(c.x) >
      Math.abs(c.y) ? c.y = 0 : c.x = 0);
      this.checkPreview();
      if (this.currentDx != c.x || this.currentDy != c.y) this.currentDx = c.x,
      this.currentDy = c.y,
      this.updatePreview()
    }
    this.updateHint(b);
...
mxGraphHandler.prototype.mouseUp = function (a, b) {
  if (!b.isConsumed()) if (this.livePreviewUsed && this.resetLivePreview(), null == this.cell || null == this.first || null == this.shape && !this.livePreviewUsed || null == this.currentDx || null == this.currentDy) this.isSelectEnabled() && this.delayedSelection && null != this.cell && this.selectDelayed(b);
   else {
    a = this.graph;
    var c = b.getCell();
    if (this.connectOnDrop && null == this.target && null != c && a.getModel().isVertex(c) && a.isCellConnectable(c) && a.isEdgeValid(null, this.cell, c)) a.connectionHandler.connect(this.cell, c, b.getEvent());
     else {
...
mxSelectionCellsHandler.prototype.refresh = function () {
  ...
  for (c = 0; c < b.length; c++) d = this.graph.view.getState(b[c]),
  null != d && (e = this.handlers.get(b[c]), null == e ? (e = this.graph.createHandler(d), this.fireEvent(new mxEventObject(mxEvent.ADD, 'state', d)), this.handlers.put(b[c], e)) : e.updateParentHighlight())
};
...
mxConnectionHandler.prototype.createMarker = function () {
  ...
  a.getCell = mxUtils.bind(this, function (b) {
    ...
    if (this.graph.isSwimlane(c) && null != this.currentPoint && this.graph.hitsSwimlaneContent(c, this.currentPoint.x, this.currentPoint.y) || !this.isConnectableCell(c)) c = null;
...
mxConnectionHandler.prototype.updateCurrentState = function (a, b) {
  ...
  if (null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentConstraint) null != this.marker.highlight && null != this.marker.highlight.state && this.marker.highlight.state.cell == this.constraintHandler.currentFocus.cell ? 'transparent' != this.marker.highlight.shape.stroke && (this.marker.highlight.shape.stroke = 'transparent', this.marker.highlight.repaint()) : this.marker.markCell(this.constraintHandler.currentFocus.cell, 'transparent'),
  null != this.previous && (this.error = this.validateConnection(this.previous.cell, this.constraintHandler.currentFocus.cell), null == this.error && (this.currentState = this.constraintHandler.currentFocus), (null != this.error || null != this.currentState && !this.isCellEnabled(this.currentState.cell)) && this.constraintHandler.reset());
   else {
...
mxConnectionHandler.prototype.mouseMove = function (a, b) {
  if (b.isConsumed() || !this.ignoreMouseDown && null == this.first && this.graph.isMouseDown) this.constraintHandler.reset();
    ...
    if (null != this.first) {
      ...
      null != this.shape && (null != this.edgeState ? this.shape.points = this.edgeState.absolutePoints : (a = [
        d
      ], null != this.waypoints && (a = a.concat(this.waypoints)), a.push(c), this.shape.points = a), this.drawPreview());
    ...
    if (!this.graph.isMouseDown && null != this.currentState && null != this.icons) {
      a = !1;
      c = b.getSource();
      for (d = 0; d < this.icons.length && !a; d++) a = c == this.icons[d].node || c.parentNode == this.icons[d].node;
...
mxConnectionHandler.prototype.updateEdgeState = function (a, b) {
  ...
  a = null;
  if (null != this.waypoints) for (a = [
  ], b = 0; b < this.waypoints.length; b++) {
...
mxConnectionHandler.prototype.createTargetVertex = function (a, b) {
  for (a = this.graph.getCellGeometry(b); null != a && a.relative; ) b = this.graph.getModel().getParent(b),
  a = this.graph.getCellGeometry(b);
...
mxConstraintHandler.prototype.setFocus = function (a, b, c) {
  this.constraints = null != b && !this.isStateIgnored(b, c) && this.graph.isCellConnectable(b.cell) ? this.isEnabled() ? this.graph.getAllConnectionConstraints(b, c) || [
  ] : [
  ] : null;
...
mxRubberband.prototype.mouseMove = function (a, b) {
  if (!b.isConsumed() && null != this.first) {
    ...
    if (null != this.div || Math.abs(d) > f || Math.abs(e) > f) null == this.div && (this.div = this.createShape()),
...
mxHandle.prototype.copyStyle = function (a) {
  this.graph.setCellStyles(a, this.state.style[a], [
    this.state.cell
  ])
};
...
mxVertexHandler.prototype.init = function () {
  ...
  if (0 >= mxGraphHandler.prototype.maxCells || this.graph.getSelectionCount() < mxGraphHandler.prototype.maxCells) {
    ...
    } else this.graph.isCellMovable(this.state.cell) && !a && 2 > this.state.width && 2 > this.state.height && (this.labelShape = this.createSizer(mxConstants.CURSOR_MOVABLE_VERTEX, mxEvent.LABEL_HANDLE, null, mxConstants.LABEL_HANDLE_FILLCOLOR), this.sizers.push(this.labelShape))
  }
...
mxVertexHandler.prototype.start = function (a, b, c) {
  if (null != this.selectionBorder) if (this.livePreviewActive = this.livePreview && 0 == this.graph.model.getChildCount(this.state.cell), this.inTolerance = !0, this.childOffsetY = this.childOffsetX = 0, this.index = c, this.startX = a, this.startY = b, this.index <= mxEvent.CUSTOM_HANDLE && this.isGhostPreview()) this.ghostPreview = this.createGhostPreview();
    ...
    if (!this.livePreviewActive || this.isLivePreviewBorder()) this.preview = this.createSelectionShape(this.bounds),
    ...
    if (this.livePreviewActive) for (this.hideSizers(), c == mxEvent.ROTATION_HANDLE ? this.rotationShape.node.style.display = '' : c == mxEvent.LABEL_HANDLE ? this.labelShape.node.style.display = '' : null != this.sizers && null != this.sizers[c] ? this.sizers[c].node.style.display = '' : c <= mxEvent.CUSTOM_HANDLE && null != this.customHandles && this.customHandles[mxEvent.CUSTOM_HANDLE - c].setVisible(!0), c = this.graph.getEdges(this.state.cell), this.edgeHandlers = [
    ], a = 0; a < c.length; a++) b = this.graph.selectionCellsHandler.getHandler(c[a]),
...
mxVertexHandler.prototype.moveToFront = function () {
  if (null != this.state.text && null != this.state.text.node && null != this.state.text.node.nextSibling || null != this.state.shape && null != this.state.shape.node && null != this.state.shape.node.nextSibling && (null == this.state.text || this.state.shape.node.nextSibling != this.state.text.node)) null != this.state.shape && null != this.state.shape.node && this.state.shape.node.parentNode.appendChild(this.state.shape.node),
  null != this.state.text && null != this.state.text.node && this.state.text.node.parentNode.appendChild(this.state.text.node)
};
mxVertexHandler.prototype.mouseUp = function (a, b) {
  if (null != this.index && null != this.state) {
    ...
    try {
      if (a <= mxEvent.CUSTOM_HANDLE) {
      ...
      } else if (a == mxEvent.ROTATION_HANDLE) if (null != this.currentAlpha) {
        ...
        q = this.isRecursiveResize(this.state, b);
        this.resizeCell(this.state.cell, this.roundLength(m / p), this.roundLength(n / p), a, f, this.isConstrainedEvent(b), q)
      }
    } finally {
      this.graph.getModel().endUpdate()
    }
  ...
  if (0 != b) {
    ...
    if (d.isVertex(a) || d.isEdge(a)) {
      if (!d.isEdge(a)) {
        ...
        this.graph.setCellStyles(mxConstants.STYLE_ROTATION, e, [
          a
        ])
      }
...
mxVertexHandler.prototype.union = function (a, b, c, d, e, f, g, k, l) {
  ...
  if (0 == d || 3 == d || 5 == d) p += b,
  p = e ? this.graph.snap(p / f) * f : Math.round(p / f) * f;
   else if (2 == d || 4 == d || 7 == d) q += b,
  q = e ? this.graph.snap(q / f) * f : Math.round(q / f) * f;
  e = q - p;
  c = r - a;
...
mxVertexHandler.prototype.redrawHandles = function () {
  ...
  if (null != this.sizers && 0 < this.sizers.length && null != this.sizers[0]) {
    if (null == this.index && this.manageSizers && 8 <= this.sizers.length) {
      ...
      if (0 != this.horizontalOffset || 0 != this.verticalOffset) a = new mxRectangle(a.x, a.y, a.width, a.height),
...
mxEdgeHandler.prototype.createMarker = function () {
  ...
  a.getCell = function (c) {
    ...
    e = b.graph.getModel();
    if (this.graph.isSwimlane(d) && null != b.currentPoint && this.graph.hitsSwimlaneContent(d, b.currentPoint.x, b.currentPoint.y) || !b.isConnectableCell(d) || d == b.state.cell || null != d && !b.graph.connectableEdges && e.isEdge(d) || e.isAncestor(b.state.cell, d)) d = null;
...
mxEdgeHandler.prototype.createBends = function () {
  for (var a = this.state.cell, b = [
  ], c = 0; c < this.abspoints.length; c++) if (this.isHandleVisible(c)) {
    ...
    (e || this.graph.isCellBendable(a)) && mxUtils.bind(this, function (f) {
      ...
      this.isHandleEnabled(c) && g.setCursor(e ? mxConstants.CURSOR_TERMINAL_HANDLE :
...
mxEdgeHandler.prototype.createVirtualBends = function () {
  ...
  if (this.graph.isCellBendable(this.state.cell)) for (var b = 1; b < this.abspoints.length; b++) mxUtils.bind(this, function (c) {
    this.initBend(c);
...
mxEdgeHandler.prototype.getHandleForEvent = function (a) {
  ...
  if (null != this.state) {
    var c = function (g) {
      if (null != g && (a.isSource(g) || g.intersectsRectangle(e))) {
        var k = a.getGraphX() - g.bounds.getCenterX();
        g = a.getGraphY() - g.bounds.getCenterY();
        k = k * k + g * g;
        if (null == f || k <= f) return f = k,
        !0
      }
      return !1
    },
    ...
    if (null != this.virtualBends && this.isAddVirtualBendEvent(a)) for (d = 0; d < this.virtualBends.length; d++) c(this.virtualBends[d]) && (b = mxEvent.VIRTUAL_HANDLE - d)
  }
  return b
};
...
mxEdgeHandler.prototype.mouseDown = function (a, b) {
  if (this.graph.isCellEditable(this.state.cell)) {
    ...
    if (this.addEnabled && null == a && this.isAddPointEvent(b.getEvent())) this.addPoint(this.state, b.getEvent()),
    b.consume();
     else if (null != a && !b.isConsumed() && this.graph.isEnabled()) {
      if (this.removeEnabled && this.isRemovePointEvent(b.getEvent())) this.removePoint(this.state, a);
       else if (a != mxEvent.LABEL_HANDLE || this.graph.isLabelMovable(b.getCell())) a <= mxEvent.VIRTUAL_HANDLE && mxUtils.setOpacity(this.virtualBends[mxEvent.VIRTUAL_HANDLE - a].node, 100),
      this.start(b.getX(), b.getY(), a);
      b.consume()
    }
  }
};
...
mxEdgeHandler.prototype.getPointForEvent = function (a) {
  ...
  if (0 < e && this.isSnapToTerminalsEvent(a)) {
    ...
    if (null != k) for (var m = 0; m < k.length; m++) (0 < m || !this.state.isFloatingTerminalPoint(!0)) && (m < k.length - 1 || !this.state.isFloatingTerminalPoint(!1)) && l.call(this, this.state.absolutePoints[m])
  }
...
mxEdgeHandler.prototype.getPreviewTerminalState = function (a) {
  ...
  a = this.graph.getModel(),
  a = this.graph.view.getTerminalPort(this.state, this.graph.view.getState(a.getTerminal(this.state.cell, !this.isSource)), !this.isSource),
  a = null != a ? a.cell : null,
  this.error = this.validateConnection(this.isSource ? this.constraintHandler.currentFocus.cell : a, this.isSource ? a : this.constraintHandler.currentFocus.cell),
  a = null,
  null == this.error && (a = this.constraintHandler.currentFocus),
  (null != this.error || null != a && !this.isCellEnabled(a.cell)) && this.constraintHandler.reset(),
  a;
  if (this.graph.isIgnoreTerminalEvent(a.getEvent())) return this.marker.reset(),
  null;
...
mxEdgeHandler.prototype.getPreviewPoints = function (a, b) {
  ...
  if (this.isSource || this.isTarget) this.graph.resetEdgesOnConnect && (c = null);
   else if (this.convertPoint(d, !1), null == c) c = [
    d
  ];
   else {
    ...
    if (!this.isSource && !this.isTarget) {
      for (var f = 0; f < this.bends.length; f++) if (f != this.index) {
        var g = this.bends[f];
        null !=
        g && mxUtils.contains(g.bounds, a.x, a.y) && (this.index <= mxEvent.VIRTUAL_HANDLE ? c.splice(mxEvent.VIRTUAL_HANDLE - this.index, 1) : c.splice(this.index - 1, 1), e = c)
      }
...
mxEdgeHandler.prototype.mouseMove = function (a, b) {
  if (null != this.index && null != this.marker) {
    ...
    if (this.index <= mxEvent.CUSTOM_HANDLE && this.index > mxEvent.VIRTUAL_HANDLE) null != this.customHandles && (this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].processEvent(b), this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].positionChanged(), null != this.shape && null != this.shape.node && (this.shape.node.style.display = 'none'));
     else if (this.isLabel) this.label.x = this.currentPoint.x,
    this.label.y = this.currentPoint.y;
     else {
      this.points = this.getPreviewPoints(this.currentPoint, b);
      a = this.isSource || this.isTarget ? this.getPreviewTerminalState(b) :
      null;
...
mxEdgeHandler.prototype.mouseUp = function (a, b) {
  if (null != this.index && null != this.marker) {
    ...
    if (b.getX() != this.startX || b.getY() != this.startY) {
      ...
      } else this.graph.isAllowDanglingEdges() && (g = this.abspoints[this.isSource ? 0 : this.abspoints.length - 1], g.x = this.roundLength(g.x / this.graph.view.scale - this.graph.view.translate.x), g.y = this.roundLength(g.y / this.graph.view.scale - this.graph.view.translate.y), k = this.graph.getView().getState(this.graph.getModel().getParent(a)), null != k && (g.x -= k.origin.x, g.y -= k.origin.y), g.x -= this.graph.panDx / this.graph.view.scale, g.y -= this.graph.panDy / this.graph.view.scale, a = this.changeTerminalPoint(a, g, this.isSource, d));
       else this.active ? a = this.changePoints(a, this.points, d) : (this.graph.getView().invalidate(this.state.cell), this.graph.getView().validate(this.state.cell))
...
mxEdgeHandler.prototype.addPointAt = function (a, b, c) {
  ...
  if (null != d) {
    ...
    null == d.points ? d.points = [
      b
    ] : d.points.splice(c, 0, b);
...
mxEdgeHandler.prototype.redrawHandles = function () {
  ...
  if (null != this.customHandles) for (a = 0; a < this.customHandles.length; a++) b = this.customHandles[a].shape.node.style.display,
  this.customHandles[a].redraw(),
  this.customHandles[a].shape.node.style.display = b,
  this.customHandles[a].shape.node.style.visibility = this.isCustomHandleVisible(this.customHandles[a]) ? '' : 'hidden'
};
...
mxEdgeHandler.prototype.redrawInnerBends = function (a, b) {
  for (a = 1; a < this.bends.length - 1; a++) if (null != this.bends[a]) if (null != this.abspoints[a]) {
...
mxEdgeHandler.prototype.refresh = function () {
  null != this.state && (this.abspoints = this.getSelectionPoints(this.state), this.points = [
  ], null != this.bends && (this.destroyBends(this.bends), this.bends = this.createBends()), null != this.virtualBends && (this.destroyBends(this.virtualBends), this.virtualBends = this.createVirtualBends()), null != this.customHandles && (this.destroyBends(this.customHandles), this.customHandles = this.createCustomHandles()), null != this.labelShape && null != this.labelShape.node && null != this.labelShape.node.parentNode && this.labelShape.node.parentNode.appendChild(this.labelShape.node))
};
...
mxEdgeSegmentHandler.prototype.getPreviewPoints = function (a) {
  ...
  if (1 == d.length) {
    ...
    e = d[0].x * f + g.x;
    f = d[0].y * f + g.y;
    if (null != b && mxUtils.contains(b, e, f) || null != c && mxUtils.contains(c, e, f)) d = [
      a,
      a
    ]
  }
...
mxEdgeSegmentHandler.prototype.updatePreviewState = function (a, b, c, d) {
  ...
  if (!this.isSource && !this.isTarget) {
    ...
    for (var e = a.absolutePoints, f = e[0], g = e[1], k = [
    ], l = 2; l < e.length; l++) {
      var m = e[l];
    ...
    if (0 == k.length && (0 == Math.round(e[0].x - e[e.length - 1].x) || 0 == Math.round(e[0].y - e[e.length - 1].y))) k = [
      b,
      b
    ];
      ...
      if (l = this.graph.getConnectionConstraint(a, g, !1)) n = this.graph.getConnectionPoint(g, l),
      null != n && (this.convertPoint(n, !1), k = n.y);
      k = [
        new mxPoint(b.x, e),
        new mxPoint(b.x, k)
      ]
...
mxEdgeSegmentHandler.prototype.connect = function (a, b, c, d, e) {
  ...
  f.beginUpdate();
  try {
    null != k && (g = f.getGeometry(a), null != g && (g = g.clone(), g.points = k, f.setGeometry(a, g))),
...
mxEdgeSegmentHandler.prototype.redrawInnerBends = function (a, b) {
  if (this.graph.isCellBendable(this.state.cell)) {
    ...
    if (null != c && 1 < c.length) {
      ...
      } else e = c[0].y + (c[c.length - 1].y - c[0].y) / 2,
      c[1] = new mxPoint(c[1].x, e),
      c[2] = new mxPoint(c[2].x, e);
      for (e = 0; e < c.length -
      1; e++) null != this.bends[e + 1] && (a = c[e], b = c[e + 1], a = new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2), b = this.bends[e + 1].bounds, this.bends[e + 1].bounds = new mxRectangle(Math.floor(a.x - b.width / 2), Math.floor(a.y - b.height / 2), b.width, b.height), this.bends[e + 1].redraw(), this.manageLabelHandle && this.checkLabelHandle(this.bends[e + 1].bounds));
...
function mxKeyHandler(a, b) {
  ...
  ], this.keydownHandler = mxUtils.bind(this, function (c) {
    this.keyDown(c)
...
mxKeyHandler.prototype.keyDown = function (a) {
  if (this.isEnabledForEvent(a)) if (27 == a.keyCode) this.escape(a);
...
mxTooltipHandler.prototype.mouseMove = function (a, b) {
  ...
  a = this.getStateForEvent(b),
  (this.isHideOnHover() || a != this.state || b.getSource() != this.node && (!this.stateSource || null != a && this.stateSource == (b.isSource(a.shape) || !b.isSource(a.text)))) && this.hideTooltip();
  this.lastX = b.getX();
  this.lastY = b.getY()
};
...
mxCellHighlight.prototype.isHighlightAt = function (a, b) {
  var c = !1;
  if (null != this.shape && null != document.elementFromPoint) for (a = document.elementFromPoint(a, b); null != a; ) {
...
mxCodec.prototype.updateElements = function () {
  ...
  }, null != this.document.documentElement && this.addElement(this.document.documentElement))
};
mxCodec.prototype.addElement = function (a) {
  if (a.nodeType == mxConstants.NODETYPE_ELEMENT) {
    var b = a.getAttribute('id');
    if (null != b) if (null == this.elements[b]) this.elements[b] = a;
     else if (this.elements[b] != a) throw Error(b + ': Duplicate ID');
  }
  for (a = a.firstChild; null != a; ) this.addElement(a),
  a = a.nextSibling
};
    ...
    if (null == g || null != f) {
      ...
      if (null != m) {
        ...
        if (null == g) {
          ...
          null != g && 'function' != typeof g && 'object' !=
        ...
        for (p = 0; p < k; p++) f = this.encodeCell(b, c, e.getChildAt(d, p)),
