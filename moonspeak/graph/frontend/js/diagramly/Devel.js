...
mxscript(drawDevUrl + 'js/diagramly/MoonspeakFile.js');
mxscript(drawDevUrl + 'js/diagramly/MoonspeakLibrary.js');
mxscript(drawDevUrl + 'js/diagramly/MoonspeakClient.js');
