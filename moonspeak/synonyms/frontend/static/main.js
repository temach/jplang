				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								synonyms: syns,
								userMessage: A2($elm$core$Dict$remove, 'SynonymsReady', model.userMessage)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								synonyms: _List_Nil,
								userMessage: A3($elm$core$Dict$insert, 'SynonymsReady', 'Error getting synonyms from thesaurus', model.userMessage)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'SelectSynonym':
				...
				var newKeyword = A2(
					$elm$core$Maybe$withDefault,
					{
						freq: _List_fromArray(
							[0, 0]),
						metadata: 'Error!',
						word: 'Error!'
					},
					A2($elm_community$list_extra$List$Extra$getAt, index, model.synonyms));
				var newModel = _Utils_update(
					model,
...
var $author$project$Main$renderSingleSynonym = F3(
	function (model, index, synonym) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(synonym.word)
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
...
var $author$project$Main$renderSynonyms = function (model) {
	var partial = $author$project$Main$renderSingleSynonym(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Keyword synonyms')
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Main$renderSynonyms(model)
					]))
			]));
};
