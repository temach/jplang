...
{
	if (region.a7.az === region.bp.az)
	{
		return 'on line ' + region.a7.az;
	}
	return 'on lines ' + region.a7.az + ' through ' + region.bp.az;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ce: 'hidden', b7: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ce: 'mozHidden', b7: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ce: 'msHidden', b7: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ce: 'webkitHidden', b7: 'webkitvisibilitychange' }
		: { ce: 'hidden', b7: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cj, request.cC, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bs: fragment, bv: host, bE: path, bG: port_, bJ: protocol, bK: query};
	});
...
var $author$project$Main$compareKeyCandidates = F2(
	function (a, b) {
		var bfreq = ((A2(
			...
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 0, b.r)) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 1, b.r))) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 2, b.r))) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 3, b.r));
		var afreq = ((A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 0, a.r)) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 1, a.r))) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 2, a.r))) + A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, 3, a.r));
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b3: false, b6: r.b6, cc: r.cc, bt: r.bt, cj: r.cj, cy: r.cy, bW: r.bW, cC: r.cC}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b6: $elm$http$Http$emptyBody, cc: r.cc, bt: _List_Nil, cj: 'GET', cy: $elm$core$Maybe$Nothing, bW: $elm$core$Maybe$Nothing, cC: r.cC});
};
...
var $author$project$Main$KeyCandidate = F3(
	function (word, metadata, freq) {
		return {r: freq, aP: metadata, aY: word};
	});
...
var $author$project$Main$synonymsDecoder = $elm$json$Json$Decode$list($author$project$Main$keyCandidateDecoder);
var $author$project$Main$getSynonyms = function (keyword) {
	return $elm$http$Http$get(
		{
			cc: A2($elm$http$Http$expectJson, $author$project$Main$SynonymsReady, $author$project$Main$synonymsDecoder),
			cC: A2(
	...
	function (msg, model) {
		switch (msg.$) {
			case 4:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$getSynonyms(newModel.m)
							])));
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							x: $elm$core$List$reverse(
								A2($elm$core$List$sortWith, $author$project$Main$compareKeyCandidates, model.x))
						}),
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								x: syns,
								X: A2($elm$core$Dict$remove, 'SynonymsReady', model.X)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								x: _List_Nil,
								X: A3($elm$core$Dict$insert, 'SynonymsReady', '{{ error_getting_synonyms }}', model.X)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 0:
			...
			default:
				...
				if (!_v2.$) {
					var value = _v2.a;
					var newKeyword = ($elm$core$String$length(value.m) > 0) ? value.m : model.m;
					var newModel = _Utils_update(
						model,
						{m: newKeyword});
					return _Utils_Tuple2(
						...
						[
							...
							$elm$core$String$fromInt(
								A2(
									$elm$core$Maybe$withDefault,
									0,
									A2($elm_community$list_extra$List$Extra$getAt, 0, synonym.r))))
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						...
						[
							...
							$elm$core$String$fromInt(
								A2(
									$elm$core$Maybe$withDefault,
									0,
									A2($elm_community$list_extra$List$Extra$getAt, 1, synonym.r))))
						]))
				]));
	});
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$String$join,
					'!',
					$elm$core$Dict$values(userMessage)))
			]));
};
var $author$project$Main$render = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Lazy$lazy, $author$project$Main$renderUserMessages, model.X),
				A3(
				...
				_List_fromArray(
					[
						$author$project$Main$renderSynonyms(model.x)
					]))
			]));
};
