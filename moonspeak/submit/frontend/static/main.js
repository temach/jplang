	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.kanji)
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
					...
					[
						...
						'Corpus: ' + $elm$core$String$fromInt(
							A2(
								...
								0,
								A2($elm_community$list_extra$List$Extra$getAt, 0, model.freq))))
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
					...
					[
						...
						'Subs: ' + $elm$core$String$fromInt(
							A2(
								$elm$core$Maybe$withDefault,
								0,
								A2($elm_community$list_extra$List$Extra$getAt, 1, model.freq))))
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
...
var $author$project$Main$render = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(250, 250, 250)'),
				A2($elm$html$Html$Attributes$style, 'overflow', 'auto')
			]),
		_List_fromArray(
			[
