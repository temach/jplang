...
var $author$project$Main$init = function (_v0) {
	var model = {
		...
		currentWorkIndex: -1,
		workElements: _List_fromArray(
			[
				A3($author$project$Main$WorkElement, 'a', 'first', ''),
				A3($author$project$Main$WorkElement, 'b', 'second', 'asd'),
				A3($author$project$Main$WorkElement, 'c', 'third', '')
			])
	};
	return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_eq(model.currentHighlightWorkElementIndex, index) ? A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(200, 250, 200)') : A2($elm$html$Html$Attributes$style, 'background-color', '')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
					...
					_List_fromArray(
						[
							...
							_Utils_eq(model.currentHighlightWorkElementIndex, index) ? A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(210, 250, 200)') : A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(210, 200, 200)')
						]),
					_List_fromArray(
						[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.WorkElement":{"args":[],"type":"{ kanji : String.String, keyword : String.String, notes : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateWorkElement":["Main.WorkElement"],"NextWorkElement":[],"SelectWorkElement":["Basics.Int"],"WorkElementsReady":["Result.Result Http.Error (List.List Main.WorkElement)"],"HighlightWorkElement":["Basics.Int"],"UnHighlightWorkElement":["Basics.Int"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));